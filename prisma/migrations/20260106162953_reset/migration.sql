-- CreateEnum
CREATE TYPE "ROLE" AS ENUM ('DOCTOR', 'PATIENT', 'NURSE', 'RECEPTIONIST', 'ADMIN', 'TECHNICIAN', 'PHARMACIST', 'HOSPITAL', 'AMBULANCE', 'PHARMACY', 'INSURANCE', 'GUEST');
...
CREATE TABLE "Mdication" (
    ...
    CONSTRAINT "Mdication_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Tag" (
    ...
    "slug" TEXT NOT NULL,
    "description" TEXT,
    "color" TEXT NOT NULL DEFAULT '#FFFF',
    "status" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Mdication_userId_key" ON "Mdication"("userId");

-- CreateIndex
CREATE INDEX "Mdication_userId_idx" ON "Mdication"("userId");
...
-- AddForeignKey
ALTER TABLE "MedicalHistory" ADD CONSTRAINT "MedicalHistory_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "MedicalHistory"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Mdication" ADD CONSTRAINT "Mdication_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
