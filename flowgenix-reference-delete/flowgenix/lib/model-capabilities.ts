import type { ModelConfig } from "./agent-storage";

export type Capability = "thinking" | "coding" | "vision" | "search" | "long-ctx";

const RULES: { cap: Capability; re: RegExp }[] = [
...
export function inferCapabilities(m: Pick<ModelConfig, "model" | "label" | "strengths">): Capability[] {
