...
export const Route = createFileRoute("/community")({
  ...
  head: () => ({
    meta: [
      { title: "Community — KonnectX WhatsApp Business API" },
      { name: "description", content: "Join the KonnectX community. Connect with other businesses, share best practices, and learn from experts." },
      { property: "og:title", content: "Community — KonnectX" },
      { property: "og:description", content: "Join the KonnectX community of 5,000+ businesses." },
    ],
  }),
});
