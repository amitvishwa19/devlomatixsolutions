...
export const Route = createFileRoute("/press")({
  ...
  head: () => ({
    meta: [
      { title: "Press — KonnectX WhatsApp Business API" },
      { name: "description", content: "KonnectX in the news. Press releases, media coverage, and brand resources." },
      { property: "og:title", content: "Press — KonnectX" },
      { property: "og:description", content: "KonnectX in the news. Press releases, media coverage, and brand resources." },
    ],
  }),
});
