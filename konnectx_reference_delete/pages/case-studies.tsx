...
export const Route = createFileRoute("/case-studies")({
  ...
  head: () => ({
    meta: [
      { title: "Case Studies — KonnectX WhatsApp Business API" },
      { name: "description", content: "See how businesses use KonnectX to drive revenue, improve support, and engage customers via WhatsApp." },
      { property: "og:title", content: "Case Studies — KonnectX" },
      { property: "og:description", content: "Real results from real businesses using KonnectX." },
    ],
  }),
});
