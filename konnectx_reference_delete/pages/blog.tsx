...
export const Route = createFileRoute("/blog")({
  ...
  head: () => ({
    meta: [
      { title: "Blog & Resources — KonnectX WhatsApp Business API" },
      { name: "description", content: "Tips, guides, and insights on WhatsApp marketing, chatbot automation, and customer engagement strategies." },
      { property: "og:title", content: "Blog & Resources — KonnectX" },
      { property: "og:description", content: "Tips, guides, and insights on WhatsApp marketing and chatbot automation." },
    ],
  }),
});
            ...
            <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {posts.map((post, i) => (
                ...
                >
                  ...
                  <Link to="/blog/$slug" params={{ slug: post.slug }} className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-primary hover:underline">
