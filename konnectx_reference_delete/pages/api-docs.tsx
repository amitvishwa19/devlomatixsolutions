...
export const Route = createFileRoute("/api-docs")({
  ...
  head: () => ({
    meta: [
      { title: "API Documentation — KonnectX WhatsApp Business API" },
      { name: "description", content: "Comprehensive API documentation for KonnectX WhatsApp Business API. RESTful endpoints, SDKs, webhooks, and more." },
      { property: "og:title", content: "API Docs — KonnectX" },
      { property: "og:description", content: "Comprehensive API documentation for KonnectX WhatsApp Business API." },
    ],
  }),
});
