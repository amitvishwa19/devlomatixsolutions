...
export const Route = createFileRoute("/help-center")({
  ...
  head: () => ({
    meta: [
      { title: "Help Center — KonnectX WhatsApp Business API" },
      { name: "description", content: "Get help with KonnectX. Browse guides, FAQs, and troubleshooting articles for the WhatsApp Business API platform." },
      { property: "og:title", content: "Help Center — KonnectX" },
      { property: "og:description", content: "Get help with KonnectX. Browse guides, FAQs, and troubleshooting articles." },
    ],
  }),
});
