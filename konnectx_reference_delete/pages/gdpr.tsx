...
export const Route = createFileRoute("/gdpr")({
  ...
  head: () => ({
    meta: [
      { title: "GDPR Compliance — KonnectX" },
      { name: "description", content: "KonnectX GDPR compliance. Learn how we protect your data rights under the General Data Protection Regulation." },
      { property: "og:title", content: "GDPR — KonnectX" },
      { property: "og:description", content: "How KonnectX ensures GDPR compliance and protects your data rights." },
    ],
  }),
});
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="glass-card rounded-xl p-6 sm:p-8 text-center" style={{ boxShadow: "var(--shadow-card)" }}>
              ...
              <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link to="/contact" className="inline-flex items-center gap-2 rounded-lg px-6 py-3 text-sm font-semibold text-primary-foreground" style={{ background: "var(--gradient-sun)" }}>
