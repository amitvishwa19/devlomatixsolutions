...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About Us — KonnectX WhatsApp Business API Platform" },
      { name: "description", content: "Learn about KonnectX — the team behind the leading WhatsApp Business API platform powering 5,000+ businesses worldwide." },
      { property: "og:title", content: "About Us — KonnectX" },
      { property: "og:description", content: "The team behind the leading WhatsApp Business API platform powering 5,000+ businesses worldwide." },
    ],
  }),
});
