...
export const Route = createFileRoute("/changelog")({
  ...
  head: () => ({
    meta: [
      { title: "Changelog — KonnectX WhatsApp Business API" },
      { name: "description", content: "See what's new in KonnectX. Latest updates, features, and improvements to our WhatsApp Business API platform." },
      { property: "og:title", content: "Changelog — KonnectX" },
      { property: "og:description", content: "Latest updates, features, and improvements to KonnectX." },
    ],
  }),
});

const entries = [
  { date: "April 2, 2026", version: "v3.4.0", type: "feature" as const, title: "AI-Powered Message Suggestions", desc: "Smart reply suggestions powered by AI to help agents respond faster and more accurately." },
  { date: "March 18, 2026", version: "v3.3.2", type: "fix" as const, title: "Webhook Delivery Improvements", desc: "Fixed intermittent delays in webhook event delivery. Improved retry logic for failed deliveries." },
  { date: "March 5, 2026", version: "v3.3.0", type: "feature" as const, title: "Advanced Campaign Segmentation", desc: "Create hyper-targeted campaigns with advanced audience segmentation based on behavior, location, and engagement history." },
  { date: "February 20, 2026", version: "v3.2.1", type: "improvement" as const, title: "Dashboard Performance Boost", desc: "50% faster dashboard loading times with optimized data fetching and caching." },
  { date: "February 8, 2026", version: "v3.2.0", type: "feature" as const, title: "Multi-Language Template Builder", desc: "Create and manage message templates in 40+ languages with built-in translation suggestions." },
  { date: "January 22, 2026", version: "v3.1.0", type: "feature" as const, title: "Shopify Integration", desc: "Native Shopify integration for order notifications, abandoned cart recovery, and customer support." },
];
