...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      { title: "Contact Us — KonnectX WhatsApp Business API Platform" },
      { name: "description", content: "Get in touch with the KonnectX team. We're here to help you get started with WhatsApp Business API." },
      { property: "og:title", content: "Contact Us — KonnectX" },
      { property: "og:description", content: "Get in touch with the KonnectX team. We're here to help you get started with WhatsApp Business API." },
    ],
  }),
});
