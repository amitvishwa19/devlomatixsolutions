...
export const Route = createFileRoute("/privacy-policy")({
  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — KonnectX" },
      { name: "description", content: "KonnectX privacy policy. Learn how we collect, use, and protect your personal information." },
      { property: "og:title", content: "Privacy Policy — KonnectX" },
      { property: "og:description", content: "How KonnectX collects, uses, and protects your data." },
    ],
  }),
});
