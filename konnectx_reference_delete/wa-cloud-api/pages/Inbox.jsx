...
export function Inbox({ data }) {
  ...
  // ----- New: assignee, labels, status, quick replies -----
  ...
  // "/" opens the quick reply picker when input is empty
