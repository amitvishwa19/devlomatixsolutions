...
const SLOT_CATEGORY_FILTER: Record<string, string[]> = {
  llm: ["LLM Models"],
  memory: ["Memory"],
  tool: ["AI / Agents", "Core"],
};
...
interface NodePanelProps {
  ...
  slotFilter?: string; // agent slot id to filter categories
}

export default function NodePanel({ onClose, onAddNode, slotFilter }: NodePanelProps) {
