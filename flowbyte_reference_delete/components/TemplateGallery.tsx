...
interface TemplateGalleryProps {
  onClose: () => void;
  onLoadTemplate: (name: string, nodes: Node[], edges: Edge[]) => void;
}

export default function TemplateGallery({ onClose, onLoadTemplate }: TemplateGalleryProps) {
              ...
              >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <span className="text-[10px] text-muted-foreground">
                        {(template.nodes as any[]).length} nodes
                      </span>
                    </div>
                  </div>
                </div>
                {!(template as any).isBuiltin && (
                  <button
                    ...
                    className="text-xs text-destructive mt-2 opacity-0 group-hover:opacity-100 transition-opacity"
                  >
                    Delete
                  </button>
                )}
