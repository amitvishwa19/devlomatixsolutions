...
type MockData = { input: Record<string, unknown>; output: Record<string, unknown> };

const generators: Record<string, (prevOutput?: Record<string, unknown>) => MockData> = {
  // Triggers
  schedule: () => ({
    input: {},
...
export function generateMockData(nodeType: string, prevOutput?: Record<string, unknown>): MockData {
