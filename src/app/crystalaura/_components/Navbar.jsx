...
const navLinks = [
  { label: "Home", path: "/crystalaura" },
  { label: "Shop", path: "/crystalaura/shop" },
  { label: "Crystals", path: "/crystalaura/crystals" },
  { label: "Vastu", path: "/crystalaura/vastu" },
  { label: "Blog", path: "/crystalaura/blog" },
  { label: "FAQ", path: "/crystalaura/faq" },
  { label: "About", path: "/crystalaura/about" },
  { label: "Contact", path: "/crystalaura/contact" },
];
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link href="/crystalaura" className="flex items-center gap-2.5 group">
