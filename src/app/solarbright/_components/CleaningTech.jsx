...
const CleaningTech = () => {
  return (
    <section id="cleaning-tech" className="py-20 md:py-28 relative overflow-hidden bg-background">
      <div className="absolute top-0 right-0 w-72 h-72 rounded-full bg-primary/5 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-60 h-60 rounded-full bg-primary/5 blur-[100px] pointer-events-none" />
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <span className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.2em] text-primary mb-3">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {methods.map((method, i) => (
            <motion.div
              ...
              className="group relative bg-card border border-border rounded-2xl overflow-hidden hover:shadow-glow hover:border-primary/20 transition-all duration-300"
            >
        ...
        >
          <div className="inline-flex items-center gap-3 bg-card border border-border rounded-full px-6 py-3 shadow-glow shadow-primary/5">
