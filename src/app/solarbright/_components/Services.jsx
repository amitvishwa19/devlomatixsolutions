    ...
    <section id="services" className="py-28 relative overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <p className="text-muted-foreground mt-4 text-lg max-w-lg mx-auto font-light">
              ...
              <div className="relative">
                <div className="flex items-start justify-between mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-medium text-primary/80 bg-primary/10 px-3 py-1 rounded-full uppercase tracking-wider">{service.tag}</span>
