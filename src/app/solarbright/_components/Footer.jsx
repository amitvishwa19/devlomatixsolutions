...
const Footer = () => {
  return (
    <footer className="border-t border-border pt-20 pb-8 relative overflow-hidden bg-muted/20">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid sm:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {["Services", "How It Works", "Cleaning Tech", "Benefits", "Pricing", "Testimonials"].map((link) => (
                <li key={link}>
                  <a
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex items-center gap-2">✉️ info@solarbright.in</li>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground/60">
          <p>© {new Date().getFullYear()} SolarBright. All rights reserved.</p>
