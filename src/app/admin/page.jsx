...
import { Briefcase, Users, CalendarCheck, Send } from "lucide-react";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from "recharts";
import { pipelineChartData, weeklyApplications } from "./_utils/mockData";
import StageBadge from "./_component/StageBadge";
        ...
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between">
                        ...
                        <Link href="/admin/candidates" className="text-sm text-primary hover:underline">View all</Link>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-3">
                            {candidates.slice(0, 5).map((c) => (
                                <Link href={`/admin/candidates/${c.id}`} key={c.id} className="flex items-center justify-between rounded-lg border p-3 hover:bg-muted/50 transition-colors">
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    <Link href="/admin/interviews" className="text-sm text-primary hover:underline">View all</Link>
                </CardHeader>
                <CardContent>
