...
import StageProgress from "../../_component/StageProgress";
import StarRating from "../../_component/StarRating";
import CandidateScorecard from "../../_component/CandidateScorecard";
import AutoMatchScore from "../../_component/AutoMatchScore";
import AICandidateSummary from "../../_component/AICandidateSummary";
import AIInterviewQuestions from "../../_component/AIInterviewQuestions";
import CollaborativeNotes from "../../_component/CollaborativeNotes";
  ...
  if (!candidate) {
    return (
      <div className="space-y-4">
        <Link href="/admin/candidates" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
            ...
            <CardContent>
              <div className="space-y-4">
                {candidateActivities.map((activity) => {
                  const iconMap = { stage_change: "🔄", note: "📝", email: "✉️", interview: "📅", rating: "⭐" };
                  return (
