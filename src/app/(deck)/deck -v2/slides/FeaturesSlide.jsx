...
const FeaturesSlide = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-background overflow-hidden">
      ...
      {/* Animated Glows */}
      <div className="absolute top-[20%] left-[-10%] w-[400px] h-[400px] rounded-full bg-primary/10 blur-3xl" />
      <div className="absolute bottom-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full bg-accent/8 blur-3xl animate-pulse" />
        ...
        >
          {coreModules.map((module, index) => (
            <motion.div
              ...
              className="group glass p-5 rounded-xl hover:bg-primary/5 transition-all duration-300"
            >
