...
const ExportButton = ({ totalSlides, onGoToSlide, getCurrentSlideElement }) => {
  ...
  return (
    <motion.button
      ...
      className="fixed top-6 left-20 p-3 glass-effect rounded-full hover:bg-muted/50 transition-colors z-50 flex items-center gap-2 disabled:opacity-50"
