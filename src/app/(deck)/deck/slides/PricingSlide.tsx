...
const PricingSlide = () => {
  const plans = [
    ...
    },
    {
      ...
      price: "₹15,000",
      period: "/month",
      description: "For mid-sized hospitals",
      features: [
    ...
    <div className="w-full h-full flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold font-display">
          Plans That <span className="text-gradient-primary">Scale</span> With You
        </h2>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl w-full">
        {plans.map((plan, index) => (
          ...
          >
            {plan.highlighted && (
              <div className="flex items-center gap-1 text-primary-foreground text-sm font-medium mb-2">
            ...
            <div className="mt-4 mb-2">
              <span className={`text-4xl font-bold ${plan.highlighted ? "text-primary-foreground" : "text-gradient-primary"}`}>
                {plan.price}
              </span>
