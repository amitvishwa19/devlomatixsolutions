    ...
    <div className="w-full h-full flex flex-col items-center justify-center">
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold font-display">
          <span className="text-gradient-primary">Integrate</span> With Everything
        </h2>
        <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
          Connect to existing systems and expand capabilities with our open API
        </p>
      </motion.div>
      ...
      <div className="relative max-w-3xl w-full">
        ...
        <motion.div
          ...
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-gradient-primary rounded-full flex items-center justify-center glow-primary z-10"
        >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 py-16">
          {integrations.map((integration, index) => (
            <motion.div
              ...
              className="glass-effect rounded-xl p-5 text-center hover:border-primary/50 transition-all hover:scale-105"
            >
