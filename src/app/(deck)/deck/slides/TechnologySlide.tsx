...
const TechnologySlide = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      ...
      >
        <span className="inline-block px-4 py-2 bg-healthcare-blue/20 text-healthcare-blue rounded-full text-sm font-medium mb-4">
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-4 max-w-4xl w-full mb-12">
        {techFeatures.map((tech, index) => (
          <motion.div
            ...
            className="glass-effect rounded-xl p-4 text-center hover:border-primary/50 transition-colors"
          >
      ...
      <motion.div
        ...
        className="glass-effect rounded-3xl p-8 max-w-3xl w-full"
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            <div className="text-3xl font-bold text-gradient-primary mb-2">99.99%</div>
            <p className="text-muted-foreground text-sm">Uptime SLA</p>
          </div>
          <div>
            <div className="text-3xl font-bold text-gradient-secondary mb-2">&lt; 100ms</div>
