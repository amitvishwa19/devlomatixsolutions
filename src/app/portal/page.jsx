...
import { Calendar, CheckCircle2, Circle, Clock, FileText, MapPin, Briefcase, MessageSquare, ChevronRight, Eye } from "lucide-react";
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-xl font-heading">Candidate Portal</CardTitle>
    ...
    return (
      <div className="min-h-screen bg-background">
        <div className="max-w-4xl mx-auto p-4 sm:p-8 space-y-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground font-heading">{currentApp.jobTitle}</h1>
              ...
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Dialog open={uploadOpen} onOpenChange={setUploadOpen}>
                  <DialogTrigger asChild>
                    <Button size="sm" variant="outline" className="gap-1"><FileText className="h-3 w-3" /> Upload</Button>
                  </DialogTrigger>
                  <DialogContent>
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto p-4 sm:p-8 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-foreground font-heading">My Applications</h1>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      <h3 className="font-semibold text-foreground font-heading">{app.jobTitle}</h3>
