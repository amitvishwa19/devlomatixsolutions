...
import { createClient } from '@/app/workspace/[workspaceId]/wacrm/_lib/supabase/server'
import { sendTextMessage, sendTemplateMessage } from '@/app/workspace/[workspaceId]/wacrm/_lib/whatsapp/meta-api'
import { decrypt, encrypt, isLegacyFormat } from '@/app/workspace/[workspaceId]/wacrm/_lib/whatsapp/encryption'
import { supabaseAdmin } from '@/app/workspace/[workspaceId]/wacrm/_lib/flows/admin-client'
import {
  sanitizePhoneForMeta,
  isValidE164,
  phoneVariants,
  isRecipientNotAllowedError,
} from '@/app/workspace/[workspaceId]/wacrm/_lib/whatsapp/phone-utils'
import {
  checkRateLimit,
  rateLimitResponse,
  RATE_LIMITS,
} from '@/app/workspace/[workspaceId]/wacrm/_lib/rate-limit'
import type { MessageTemplate } from '@/types'
import { isMessageTemplate } from '@/app/workspace/[workspaceId]/wacrm/_lib/whatsapp/template-row-guard'
