                    ...
                    <div className="p-8 pb-4 relative z-10">
                        <div className="flex flex-col items-center text-center gap-4">
                            ...
                            <div className="space-y-2">
                                <DialogTitle className="text-xl font-bold Template tracking-tight">
                                    Purge Campaign?
                                </DialogTitle>
                                <DialogDescription className="text-xs font-medium text-muted-foreground leading-relaxed px-4">
                                    You are about to permanently delete <span className="text-foreground font-bold underline decoration-red-500/30 underline-offset-4">{campaignName || 'this deployment'}</span> and all associated metrics.
                                </DialogDescription>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="px-8 py-6 space-y-4 relative z-10">
                        <div className="p-4 rounded-xl bg-muted/30 border border-border/40 flex items-start gap-3">
                            ...
                            <p className="text-[10px] text-muted-foreground/80 leading-relaxed font-medium">
                                Irreversible action. This will remove all delivery records from the system orchestration layer. Active broadcasts will be terminated immediately.
                            </p>
                        </div>
                    </div>
