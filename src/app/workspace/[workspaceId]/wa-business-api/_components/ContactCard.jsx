                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-1 pt-0.5">
                            {contact.tags?.map(tag => (
                                <Badge key={tag} variant="secondary" className="text-[9px] h-4 px-1 opacity-70 border-none" style={{ backgroundColor: `${getTagColor ? getTagColor(tag) : '#ccc'}30`, color: getTagColor ? getTagColor(tag) : '#666' }}>
                                    {tag}
                                </Badge>
                            ))}
