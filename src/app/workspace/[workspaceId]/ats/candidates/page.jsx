                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1 bg-muted/30 p-1.5 rounded-xl border border-border/10 ml-2">
                        <Button
                            ...
                            className={`h-11 w-11 rounded-lg transition-all ${viewMode === 'list' ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'opacity-40 hover:opacity-100'}`}
                        >
                            <ListIcon size={18} />
                        </Button>
                        <Button
                            ...
                            className={`h-11 w-11 rounded-lg transition-all ${viewMode === 'grid' ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'opacity-40 hover:opacity-100'}`}
                        >
                            <LayoutGrid size={18} />
                        </Button>
                    </div>
                        ...
                        <Table>
                            <TableHeader className="bg-muted/50">
                                <TableRow className="border-border/40 hover:bg-transparent">
                                    <TableHead className="text-[10px] font-black uppercase tracking-widest py-5 px-6">Candidate</TableHead>
                                    <TableHead className="text-[10px] font-black uppercase tracking-widest py-5">Role</TableHead>
                                    <TableHead className="text-[10px] font-black uppercase tracking-widest py-5 text-center">AI Score</TableHead>
                                    <TableHead className="text-[10px] font-black uppercase tracking-widest py-5">Stage</TableHead>
                                    <TableHead className="text-[10px] font-black uppercase tracking-widest py-5">Location</TableHead>
                                    <TableHead className="text-[10px] font-black uppercase tracking-widest py-5">Applied</TableHead>
                                        ...
                                        <TableCell className="py-4 px-6">
                                            <div className="flex items-center gap-3">
                                                <Avatar className="h-9 w-9 border border-primary/20">
                                                    <AvatarFallback className="bg-primary/5 text-primary font-black uppercase text-[10px]">
                                        ...
                                        <TableCell className="text-right px-6">
                                            <div className="flex items-center justify-end gap-2">
                                                <Button
                                                    variant="ghost"
                                                    size="icon"
                                                    className="h-8 w-8 rounded-lg opacity-40 hover:opacity-100 hover:bg-primary hover:text-white transition-all shadow-none"
