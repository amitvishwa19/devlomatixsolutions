...
export default function CandidateProfilePage() {
 ...
 <Button variant="ghost" size="icon" className="h-10 w-10 rounded-md opacity-60 hover:opacity-100" onClick={() => setActiveTab('emails')}>
 <Mail size={18} />
 </Button>
 <Button variant="ghost" size="icon" className="h-10 w-10 rounded-md opacity-60 hover:opacity-100">
 <Calendar size={18} />
 </Button>
 ...
 <div className="w-10 h-10 rounded-md bg-muted/60 flex items-center justify-center opacity-40 group-hover:opacity-100 group-hover:text-primary transition-all">
 <Mail size={16} />
 </div>
 <div>
 ...
 <Button variant="outline" size="icon" className="h-10 w-10 rounded-md border-border/20">
 <Plus size={16} />
 </Button>
 <Button variant="outline" size="icon" className="h-10 w-10 rounded-md border-border/20">
 <FileText size={16} />
