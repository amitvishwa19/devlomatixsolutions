                    ...
                    <CardContent className="p-8 pt-4 space-y-8">
                        ...
                        <div className="p-6 rounded-lg bg-primary/5 border border-primary/10 flex items-center gap-4">
                            ...
                            <p className="text-xs font-medium text-muted-foreground leading-relaxed">
                                <span className="font-black text-primary uppercase mr-2 text-[10px]">AI insight</span>
                    ...
                    <CardContent className="p-8 pt-4 space-y-8">
                        <div className="aspect-square rounded-full border-[20px] border-muted/20 relative flex items-center justify-center overflow-hidden group">
                            <div className="text-center">
                                ...
                                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground opacity-40">Inbound</p>
                            </div>
                    ...
                    <CardContent className="p-8 space-y-8">
                        <div className="grid grid-cols-2 gap-8">
                             <div className="space-y-4">
                                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground opacity-40">Gender Distribution</p>
                             ...
                             <div className="space-y-4">
                                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground opacity-40">Ethnicity Mix</p>
                                <div className="space-y-3">
                                    {[
                            ...
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b border-border/10 bg-muted/10">
                                        <th className="px-8 py-4 text-[10px] font-black uppercase tracking-widest opacity-40">Interviewer</th>
                                        <th className="px-8 py-4 text-[10px] font-black uppercase tracking-widest opacity-40">Interviews</th>
                                        <th className="px-8 py-4 text-[10px] font-black uppercase tracking-widest opacity-40">Avg Score</th>
                                        <th className="px-8 py-4 text-[10px] font-black uppercase tracking-widest opacity-40">Accept Rate</th>
                                    </tr>
                                </thead>
                            ...
                            {[
                                ...
                                <div key={i} className="p-6 rounded-lg bg-muted/20 border border-border/10 group cursor-default hover:border-primary/20 transition-all">
                                    <div className="flex items-center justify-between mb-4">
                                        <h4 className="text-sm font-black tracking-tight tracking-tighter group-hover:text-primary transition-colors">{job.role}</h4>
                                        <Badge variant="outline" className={`text-[9px] font-black uppercase border-border/40 ${job.velocity === 'Slow' ? 'text-amber-500 bg-amber-500/10' : ''}`}>
                                            {job.velocity}
                                        </Badge>
                                    </div>
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Button variant="ghost" className="h-6 text-[9px] font-black uppercase p-0">View Details</Button>
                                        </div>
                                    </div>
                                </div>
                            ))}
