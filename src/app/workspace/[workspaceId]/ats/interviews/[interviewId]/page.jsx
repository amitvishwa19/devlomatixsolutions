...
export default function InterviewSpacePage() {
    ...
    return (
        <div id='main-container' className="flex w-full h-screen text-white overflow-hidden font-sans bg-[#0A0A0B]">
            {/* Left Sidebar: Interview Context & Feedback */}
            <div className="w-[30%] h-full border-r border-white/5  backdrop-blur-3xl p-6 flex flex-col gap-6 min-w-0">
                <div className="flex items-center gap-2 shrink-0">
                    <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => router.back()}
                        className="p-0 h-auto hover:bg-transparent text-muted-foreground hover:text-primary transition-colors text-[10px] font-black uppercase tracking-[0.2em]"
                    >
                ...
                <div className="space-y-4 shrink-0">
                    <div className="flex items-center gap-4">
                        <Avatar className="h-14 w-14 border-2 border-primary/20 shadow-2xl">
                            <AvatarFallback className="bg-primary/10 text-primary font-black text-lg uppercase italic">RS</AvatarFallback>
                        </Avatar>
                        <div className="min-w-0">
                            <h1 className="text-xl font-black tracking-tighter truncate">Rohit Sharma</h1>
                            <p className="text-[10px] font-black uppercase tracking-widest text-primary/60 italic truncate">Frontend Developer Candidate</p>
                        </div>
                    </div>
                    <div className="flex gap-2">
                        <Badge variant="outline" className="h-6 rounded-md bg-white/5 border-white/10 text-[9px] font-black uppercase tracking-widest">Technical Round</Badge>
                        <Badge variant="outline" className="h-6 rounded-md bg-primary/10 border-primary/20 text-primary text-[9px] font-black uppercase tracking-widest">A-Priority</Badge>
                    </div>
                </div>
                ...
                <Tabs defaultValue="notes" className="flex-1 flex flex-col min-h-0">
                    <TabsList className="bg-white/5 p-1 rounded-lg h-9 border border-white/10 shrink-0">
                        <TabsTrigger value="notes" className="rounded-md text-[8px] font-black uppercase tracking-widest flex-1 px-1">Notes</TabsTrigger>
                        <TabsTrigger value="scorecard" className="rounded-md text-[8px] font-black uppercase tracking-widest flex-1 px-1">Score</TabsTrigger>
                        <TabsTrigger value="resume" className="rounded-md text-[8px] font-black uppercase tracking-widest flex-1 px-1">Resume</TabsTrigger>
                    </TabsList>

                    <TabsContent value="notes" className="flex-1 mt-4 outline-none min-h-0 flex flex-col overflow-hidden">
                        <div className="flex-1 min-h-0 bg-white/5 rounded-xl border border-white/5 p-5 overflow-y-auto scrollbar-hide">
                            <p className="text-[9px] font-bold text-white/20 uppercase tracking-widest italic mb-4">Transcription Start...</p>
                            <div className="space-y-5">
                                <div className="space-y-1">
                                    <p className="text-[9px] font-black text-primary italic uppercase tracking-widest">Interviewer (You)</p>
                                    <p className="text-sm font-medium opacity-60">Can you explain your experience with Next.js Server Components?</p>
                                </div>
                                <div className="space-y-1">
                                    <p className="text-[9px] font-black text-white/40 italic uppercase tracking-widest">Rohit Sharma</p>
                        ...
                        <div className="mt-4 relative group shrink-0">
                            ...
                            />
                            <div className="absolute bottom-3 right-4 text-[8px] font-black text-white/20 uppercase tracking-widest italic group-focus-within:text-primary transition-colors">Shift + Enter to save</div>
                        </div>
                    </TabsContent>
                    ...
                    <TabsContent value="scorecard" className="flex-1 mt-4 outline-none overflow-y-auto pr-1 scrollbar-hide">
                        <div className="space-y-6 p-1">
                                ...
                                <div key={i} className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[9px] font-black uppercase tracking-widest opacity-60">{trait.label}</span>
                                        </div>
                            ...
                            <Button className="w-full bg-primary hover:bg-primary/90 rounded-xl h-10 font-black uppercase tracking-widest text-[9px] shadow-lg shadow-primary/20 mt-2">
            ...
            <div className="flex-1 flex flex-col p-6 gap-6 relative bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#131317] to-black min-w-0">
                ...
                <div className="flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-3 bg-white/5 px-4 py-1.5 rounded-full border border-white/10 backdrop-blur-xl">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[8px] font-black uppercase tracking-widest text-emerald-500/80">Live Session • 12:45</span>
                        </div>
                        <Separator orientation="vertical" className="h-2.5 bg-white/10" />
                        <span className="text-[8px] font-black uppercase tracking-widest text-white/40 italic">U12-99X</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Badge variant="ghost" className="h-7 rounded-full bg-white/5 border border-white/10 text-[9px] font-black uppercase tracking-widest px-3">+2</Badge>
                    </div>
                </div>
                ...
                <div className="flex-1 grid grid-cols-2 gap-6 min-h-0 relative">
                    ...
                    {/* My Feed */}
                    <div className="relative rounded-2xl overflow-hidden border border-white/5 shadow-2xl bg-[#0F0F11] flex items-center justify-center">
                        <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
                            {isVideoOff ? (
                                ...
                                <div className="absolute inset-0 bg-zinc-900 flex items-center justify-center opacity-40 italic font-black text-white/5 uppercase tracking-widest text-2xl">Camera Active</div>
                            )}
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent" />
                        </div>
                        <div className="absolute bottom-6 left-6 flex items-center gap-2">
                            <Badge className="bg-primary/20 backdrop-blur-xl text-primary border-primary/20 font-black italic text-[9px] px-2.5 py-0.5 tracking-widest uppercase">YOU</Badge>
                    ...
                    {isScreenSharing && (
                        <div className="absolute inset-0 z-50 bg-black/95 rounded-2xl border border-primary/40 flex items-center justify-center">
                            <div className="text-center space-y-4">
                                ...
                                <h3 className="text-xl font-black uppercase tracking-widest">Presenting Screen</h3>
                                <Button onClick={() => setIsScreenSharing(false)} className="bg-rose-500 hover:bg-rose-600 rounded-lg px-6 h-10 font-black uppercase tracking-widest text-[9px]">Stop Sharing</Button>
                            </div>
                        </div>
                    )}
                </div>
                ...
                <div className="shrink-0 flex items-center justify-center gap-5 pb-1">
                    <div className="flex items-center gap-2 bg-white/5 p-1.5 rounded-xl border border-white/10 backdrop-blur-3xl shadow-2xl">
                        <Button
                            variant="ghost"
                            size="icon"
                    ...
                    <Button className="bg-[#FF3B30] hover:bg-[#FF3B30]/90 rounded-xl h-11 px-6 shadow-lg shadow-rose-500/20 flex items-center gap-2 group">
                        ...
                        <span className="font-black uppercase tracking-widest text-[9px]">End</span>
                    </Button>
                </div>
                    ...
                    {activeTool && (
                        ...
                        >
                            ...
                            <div className="flex-1 overflow-y-auto p-4 scrollbar-hide">
                                {activeTool === 'ai' && (
                                    <div className="space-y-4">
                                        <div className="bg-primary/10 border border-primary/20 p-3 rounded-xl">
                                            <p className="text-[10px] font-black text-primary uppercase tracking-widest mb-1">AI Suggestion</p>
                                        ...
                                        <div className="space-y-2">
                                            <p className="text-[9px] font-black uppercase tracking-widest opacity-40">Relevant Topics</p>
                                ...
                                {activeTool === 'code' && (
                                    <div className="bg-black/40 rounded-xl p-4 font-mono text-[11px] leading-relaxed border border-white/5 h-full">
                                ...
                                {activeTool === 'terminal' && (
                                    <div className="bg-[#0D0D0F] rounded-xl p-4 font-mono text-[10px] border border-white/5 h-full space-y-1">
                                ...
                                {activeTool === 'settings' && (
                                    <div className="space-y-6">
                                        <div className="space-y-3">
                                            <p className="text-[9px] font-black uppercase tracking-widest opacity-40">Microphone</p>
                                            <div className="h-10 bg-white/5 rounded-xl border border-white/10 flex items-center px-4 text-xs">Standard Internal Mic</div>
                                        </div>
                                        <div className="space-y-3">
                                            <p className="text-[9px] font-black uppercase tracking-widest opacity-40">Camera</p>
            ...
            <div className="w-[70px] h-full border-l border-white/5 bg-[#0F0F11]/80 backdrop-blur-3xl p-4 flex flex-col items-center gap-8 shrink-0">
                <Button
                    variant="ghost"
                    size="icon"
                    onClick={() => setActiveTool('ai')}
                    className={`h-10 w-10 rounded-xl transition-all shadow-lg ${activeTool === 'ai' ? 'bg-primary/10 text-primary shadow-primary/10 opacity-100' : 'opacity-40 hover:opacity-100 hover:text-primary'}`}
                >
                    <Sparkles size={20} />
                </Button>
