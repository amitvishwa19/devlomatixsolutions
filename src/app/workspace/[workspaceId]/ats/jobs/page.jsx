...
export default function JobManagementPage() {
    ...
    return (
        <div className="flex flex-col gap-4 p-4  animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-3">
                    <Button
                        ...
                        className="h-10 rounded-md px-6 font-bold uppercase tracking-widest text-[10px] bg-primary shadow-lg shadow-primary/20"
                    >
            ...
            {/* Filters Bar */}
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-2 rounded-lg bg-card/30 backdrop-blur-xl border border-border/40 shadow-xl shadow-black/5">
            ...
            {/* Jobs List */}
            <div className="bg-card/30 backdrop-blur-xl border border-border/40 rounded-lg overflow-hidden shadow-2xl shadow-black/10">
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-border/40 bg-muted/10">
                                <th className="p-6 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground opacity-40">Position</th>
                                <th className="p-6 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground opacity-40">Department</th>
                                <th className="p-6 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground opacity-40">Location</th>
                                <th className="p-6 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground opacity-40 text-center">Applicants</th>
                                <th className="p-6 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground opacity-40">Status</th>
                                <th className="p-6 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground opacity-40"></th>
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    >
                                        <td className="p-6">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] font-bold text-muted-foreground opacity-60 uppercase tracking-widest">{job.type}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="p-6">
                                        ...
                                        <td className="p-6">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className={`text-[10px] font-black uppercase tracking-widest ${getStatusColor(job.status).split(' ')[1]}`}>
                                                    {job.status}
                                                </span>
                                            </div>
                                        </td>
                                        <td className="p-6">
                                            <div className="flex items-center justify-end gap-2">
                                                <Button
                                                    ...
                                                    size="sm"
                                                    className="h-8 px-4 rounded-lg bg-primary text-primary-foreground font-black uppercase tracking-widest text-[9px] shadow-lg shadow-primary/20 opacity-0 group-hover:opacity-100 transition-all scale-95 group-hover:scale-100"
                                                >
                                                    View Pipeline
                                                </Button>
                                                <DropdownMenu>
