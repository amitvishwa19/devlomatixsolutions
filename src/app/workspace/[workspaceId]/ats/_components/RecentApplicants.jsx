    ...
    return (
        <Card className="border-border/40 bg-card/30 backdrop-blur-xl rounded-lg overflow-hidden shadow-2xl shadow-black/5">
            <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="text-xl font-black tracking-tight">Recent Applicants</CardTitle>
            ...
            <CardContent className="px-2">
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="space-y-0.5">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground opacity-40">{applicant.role}</p>
                                </div>
                            </div>
                            <div className="flex flex-col items-end gap-1.5">
                                <Badge className={`text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full ${getStatusColor(applicant.status)}`}>
                                    {applicant.status}
                                </Badge>
                                <div className="flex items-center gap-2">
                                    {applicant.score && (
                ...
                <Button variant="ghost" className="w-full mt-4 text-[10px] font-black uppercase tracking-[0.2em] opacity-40 hover:opacity-100 hover:bg-primary/5 rounded-lg h-12">
