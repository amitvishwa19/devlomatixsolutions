        ...
        <Card className="border-border/40 bg-card/30 backdrop-blur-xl rounded-lg overflow-hidden shadow-2xl shadow-black/5">
            <CardHeader className="flex flex-row items-center justify-between pb-6">
                <div className="space-y-1">
                    <CardTitle className="text-2xl font-black tracking-tight tracking-tighter">Hiring Pipeline</CardTitle>
                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground opacity-40">Candidate Flow across all jobs</p>
                </div>
                <Button variant="outline" className="h-10 rounded-lg px-4 font-black uppercase tracking-widest text-[9px] border-border/40 bg-card/40 backdrop-blur-xl">
                    ...
                    {displayStages.map((stage, i) => (
                        ...
                        >
                            <div className="flex flex-col gap-1">
                                ...
                                <h4 className="text-xs font-black uppercase tracking-widest opacity-60">{stage.label}</h4>
