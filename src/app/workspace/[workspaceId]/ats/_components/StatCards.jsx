        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {displayStats.map((stat, i) => {
                ...
                return (
                    ...
                    >
                        <Card className="border bg-card/30 backdrop-blur-xl rounded-md overflow-hidden shadow-2xl shadow-black/5 group hover:shadow-primary/5 hover:border-primary/50 transition-all duration-500 hover:-translate-y-1">
