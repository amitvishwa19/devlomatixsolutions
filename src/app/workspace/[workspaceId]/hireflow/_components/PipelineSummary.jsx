...
export const PipelineSummary = ({ stats, nextInterview }) => {
    ...
    return (
        <Card className="border-border bg-card/30 backdrop-blur-xl rounded-md overflow-hidden shadow-xl shadow-black/5 hover:border-primary/40 animate-in fade-in duration-700">
