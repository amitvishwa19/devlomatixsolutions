            ...
            <div className="flex flex-wrap gap-1">
              {selectedRoles.map((role) => (
                ...
                >
                  ...
                  <span className="truncate max-w-[150px]">{titleCaseLabel(role.title)}</span>
                  <div
                    type="button"
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 flex-1">
                        ...
                        <div className="flex flex-col">
                          <span className="font-medium">{titleCaseLabel(role.title)}</span>
                          {role.description && (
                            <span className="text-xs text-muted-foreground line-clamp-1 text-[10px]">
                              {role.description}
                            </span>
                          )}
                        </div>
