...
export default function PermissionCard({ permission, onEdit, onDelete, rolesWithPermission }) {
    ...
    return (
        <div className="group relative overflow-hidden rounded-lg border border-border bg-card p-5 shadow-soft transition-all duration-300 hover:shadow-medium animate-fade-in flex flex-row justify-between">
