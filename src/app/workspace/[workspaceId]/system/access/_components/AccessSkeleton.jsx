    ...
    return (
        <div className="flex flex-col gap-6 w-full animate-pulse-slow">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="h-32 rounded-lg bg-muted/20 border border-border/10 relative overflow-hidden">
            ...
            {/* Table Area Skeleton */}
            <div className="rounded-lg border border-border/10 bg-card/10 overflow-hidden flex-1 flex flex-col min-h-[400px]">
                {/* Search Bar Bar */}
                <div className="flex items-center justify-between p-4 border-b border-border/10 bg-muted/5">
                    <div className="relative w-64 h-10 rounded-lg bg-muted/20" />
                    <div className="flex gap-2">
                        <div className="w-24 h-9 rounded-lg bg-muted/20" />
                        <div className="w-32 h-9 rounded-lg bg-muted/20" />
                    </div>
                </div>
