...
export const IntegrationSettings = () => {
 ...
 disabled={saving}
 className="rounded-md font-bold bg-emerald-600 hover:bg-emerald-700 text-white shadow-xl shadow-emerald-500/20 gap-2 h-10 px-6"
 >
 ...
 <CardHeader>
 <div className="w-10 h-10 bg-amber-500/10 rounded-md flex items-center justify-center mb-2 border border-amber-500/20">
