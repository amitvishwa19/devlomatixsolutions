...
export const DeveloperSettings = () => {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="p-6 bg-fuchsia-500/5 rounded-2xl border border-fuchsia-500/10 flex gap-6 items-center">
                <div className="w-16 h-16 bg-fuchsia-500/10 rounded-2xl flex items-center justify-center border border-fuchsia-500/20 shadow-inner shrink-0 scale-110">
                    <Terminal className="w-8 h-8 text-fuchsia-500" />
                </div>
                <div className="flex-1">
                    <div className="flex items-center gap-2">
                        <Badge variant="outline" className="bg-fuchsia-500/10 text-fuchsia-600 border-fuchsia-500/20 text-[9px] font-black uppercase tracking-widest">Dev Hub</Badge>
                        <h3 className="text-lg font-black tracking-tight text-foreground uppercase">Developer Operations</h3>
                    </div>
            ...
            <Tabs defaultValue="webhooks" className="w-full">
                <TabsList className="bg-background/50 border border-border/40 p-1 rounded-xl mb-6">
                ...
                <TabsContent value="webhooks" className="mt-0 space-y-4">
                    <Card className="rounded-2xl border border-border/40 shadow-xl shadow-fuchsia-500/5 bg-card/60 backdrop-blur-md overflow-hidden">
                        <CardHeader className="flex flex-row items-center justify-between pb-4">
                            ...
                            <Dialog open={isAddWebhookOpen} onOpenChange={setIsAddWebhookOpen}>
                                <DialogTrigger asChild>
                                    <Button size="sm" className="rounded-xl gap-2 bg-fuchsia-600 hover:bg-fuchsia-700 text-white font-bold h-9">
                                        <Plus className="w-4 h-4" />
                                        Add Endpoint
                                    </Button>
                                </DialogTrigger>
                                <DialogContent className="sm:max-w-[425px] rounded-2xl border-fuchsia-500/20 bg-card/95 backdrop-blur-xl shadow-2xl">
                                    <DialogHeader>
                                    ...
                                    <div className="grid gap-6 py-4">
                                        <div className="grid gap-3">
                                            <div className="flex items-center justify-between ml-1">
                                                <Label className="text-[10px] font-bold tracking-widest uppercase opacity-70">Endpoint URL</Label>
                                                <div className="flex items-center gap-2">
                                                    <Button 
                                                        variant="ghost" 
                                                        size="sm" 
                                                        className="h-6 text-[9px] font-black text-indigo-600 hover:bg-indigo-500/10 gap-1 uppercase tracking-tighter"
                                                    ...
                                                    <Button 
                                                        variant="ghost" 
                                                        size="sm" 
                                                        className="h-6 text-[9px] font-black text-fuchsia-600 hover:bg-fuchsia-500/10 gap-1 uppercase tracking-tighter"
                                            ...
                                            <div className="relative">
                                                ...
                                                <Input
                                                    ...
                                                    className="pl-10 rounded-xl border border-border/50 h-11 bg-background shadow-inner font-bold text-xs focus:ring-2 focus:ring-fuchsia-500/20"
                                        ...
                                        <div className="grid gap-3">
                                            <Label className="text-[10px] font-bold tracking-widest uppercase opacity-70 ml-1">Event Subscriptions</Label>
                                            <div className="grid grid-cols-1 gap-2 p-3 bg-muted/30 rounded-xl border border-border/40 max-h-[150px] overflow-y-auto custom-scrollbar">
                                    ...
                                    <DialogFooter className="gap-2">
                                        <Button variant="ghost" onClick={() => setIsAddWebhookOpen(false)} className="rounded-xl font-bold uppercase tracking-widest text-[10px]">Cancel</Button>
                                        <Button 
                                            onClick={handleAddWebhook}
                                            disabled={saving}
                                            className="rounded-xl font-bold bg-fuchsia-600 hover:bg-fuchsia-700 text-white shadow-xl shadow-fuchsia-500/20 px-6 h-11"
                                        >
                                ...
                                webhooks.map((hook) => (
                                    <div key={hook.id} className="p-4 border-t border-border/10 hover:bg-fuchsia-500/5 transition-colors">
                                        <div className="flex items-center justify-between mb-3">
                                            ...
                                            <Badge className="bg-emerald-500 hover:bg-emerald-500 text-white font-black text-[9px] tracking-widest uppercase h-5 px-2">Active</Badge>
                                        </div>
                                        <div className="flex justify-end gap-2">
                                            <Button 
                                                variant="ghost" 
                                                size="sm" 
                                                className="text-[10px] font-black tracking-widest uppercase h-7 px-3 gap-2"
                                            ...
                                            <Button 
                                                ...
                                                disabled={saving}
                                                className="text-[10px] font-black tracking-widest uppercase h-7 px-3 text-rose-500 hover:bg-rose-500/10"
                                            >
                                                Delete
                                            </Button>
                                        </div>
                    ...
                    {/* Automation Assist */}
                    <Card className="rounded-2xl border border-indigo-500/20 bg-indigo-500/5 shadow-xl shadow-indigo-500/5 overflow-hidden">
                        <CardHeader className="pb-3">
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-indigo-500/20 rounded-xl">
                                    <ShieldAlert className="w-4 h-4 text-indigo-500" />
                                </div>
                                <CardTitle className="text-sm font-bold tracking-tight">Internal Mock Tester</CardTitle>
                            </div>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center gap-2 p-3 bg-background/50 rounded-xl border border-indigo-500/10">
                ...
                <TabsContent value="apikeys" className="mt-0 space-y-4">
                            ...
                            {apiKeys.map((key) => (
                                <div key={key.id} className="flex items-center justify-between p-4 border-t border-border/10 hover:bg-fuchsia-500/5 transition-colors group">
                                    ...
                                    <div className="text-right flex items-center gap-6">
                                        <div>
                                            <p className="text-[9px] font-black tracking-widest uppercase opacity-40">Created</p>
                    ...
                    <div className="p-4 bg-amber-500/5 rounded-xl border border-amber-500/10 flex gap-4 items-start">
                        <div className="p-2 bg-amber-500/10 rounded-xl mt-0.5">
                            <ShieldCheck className="w-4 h-4 text-amber-600" />
                        </div>
                        <div className="space-y-1">
                            <p className="text-[11px] font-bold text-amber-600 tracking-wide uppercase">Security Best Practice</p>
                ...
                <TabsContent value="activity" className="mt-0 space-y-4">
                    <Card className="rounded-2xl border border-border/40 shadow-xl shadow-indigo-500/5 bg-card/60 backdrop-blur-md overflow-hidden min-h-[400px]">
                        <CardHeader className="flex flex-row items-center justify-between pb-4">
                            <div>
                            ...
                            <Button 
                                variant="outline" 
                                size="sm" 
                                className="rounded-xl gap-2 h-9 px-4 border-indigo-500/20 text-indigo-600 font-bold text-[10px] tracking-widest uppercase"
                                onClick={fetchLogs}
                        ...
                        <CardContent className="p-0">
                            {activityLogs.length > 0 ? (
                                activityLogs.map((log) => (
                                    <div key={log.id} className="p-4 border-t border-border/10 hover:bg-muted/30 transition-colors flex gap-4 items-start">
                                        ...
                                        <div className="flex-1 min-w-0 space-y-1">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <Badge variant="outline" className="text-[9px] font-black tracking-widest uppercase h-4 px-1.5 opacity-60">{log.type}</Badge>
                                ...
                                <div className="p-24 text-center opacity-40">
                                    ...
                                    <p className="text-xs font-bold tracking-widest uppercase">No activity recorded</p>
                                </div>
                            )}
                        </CardContent>
                    </Card>
