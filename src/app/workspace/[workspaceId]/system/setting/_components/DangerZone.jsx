...
export const DangerZone = () => {
 ...
 variant="destructive" 
 size="sm" 
 className="rounded-md text-[10px] tracking-[0.2em] h-10 px-6 bg-rose-500 hover:bg-rose-600 shadow-xl shadow-rose-500/30 transition-all transform hover:scale-105"
