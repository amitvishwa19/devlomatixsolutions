...
export const DangerZone = () => {
 ...
 variant="outline" 
 size="sm" 
 className={`rounded-xl text-[10px] font-bold h-9 px-4 transition-all ${isMaintenanceMode ? 'bg-amber-500 text-white border-none' : 'text-amber-500 border-amber-500/20'}`}
 onClick={() => {
 ...
 <Button variant="outline" size="sm" className="rounded-xl text-[10px] font-bold h-9 px-4 text-blue-500 border-blue-500/20">
 RESET ALL
 </Button>
 </div>
