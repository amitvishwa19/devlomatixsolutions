...
import { SettingContentSkeleton, SettingPageSkeleton } from './_components/SettingSkeleton';
        ...
        >
          ...
          <nav className="p-3 space-y-1 text-sm">
            ...
            <motion.button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left transition-all ${activeTab === 'danger'
              ...
              initial={{ opacity: 0, x: -10 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: filteredTabs.length * 0.04 }}
            >
                ...
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 rounded-xl bg-white/5 border border-white/10">
                    {React.createElement(
                      ...
                      { className: `w-6 h-6 ${activeTab === 'danger' ? 'text-rose-500' : 'text-primary'}` }
                    )}
                  </div>
                  <div>
