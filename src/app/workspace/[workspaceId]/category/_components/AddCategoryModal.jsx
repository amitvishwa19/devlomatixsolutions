                ...
                <form onSubmit={onSubmit} className="flex flex-col">
                    ...
                    <div className="p-8 space-y-6 max-h-[60vh] overflow-y-auto">
                        <div className="space-y-4">
                            <div className="space-y-2 text-left">
                                <label className="text-[10px] font-bold tracking-widest text-muted-foreground ml-1 flex items-center gap-1.5">
                            ...
                            <div className="space-y-2 text-left">
                                ...
                                <Select value={parentId} onValueChange={setParentId} disabled={isLoading}>
                                    <SelectTrigger className="h-12 bg-muted/30 border-none rounded-md focus-visible:ring-1 focus-visible:ring-primary shadow-inner text-[10px] font-bold tracking-widest">
                                        <SelectValue placeholder="None (Top-level)" />
                                    </SelectTrigger>
                                    <SelectContent className="rounded-md border-border/40">
                                        <SelectItem value="none" className="font-bold text-[10px] tracking-widest rounded-md">
                                            NONE (TOP-LEVEL CATEGORY)
                                        </SelectItem>
                                        {availableParents.map((parent) => (
                                            <SelectItem key={parent.id} value={parent.id} className="font-bold text-[10px] tracking-widest rounded-md">
                    ...
                    <DialogFooter className="p-8 pt-0 flex gap-3">
                        <Button
                            ...
                            variant="outline"
                            onClick={handleClose}
                            className="h-12 rounded-md font-bold flex-1 border-border/100 bg-background/50 text-[10px] tracking-widest"
                        >
                            Cancel
                        </Button>
                        <Button
                            disabled={isLoading}
                            className="h-12 rounded-md font-bold flex-1 bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 text-[10px] tracking-widest"
                        >
                            {isLoading ? (
