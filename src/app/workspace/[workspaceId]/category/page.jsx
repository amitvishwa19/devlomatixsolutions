...
export default function CategoryManagementPage() {
        ...
        <tr key={category.id} className={`group hover:bg-primary/[0.02] transition-colors ${isChild ? 'bg-muted/5' : ''}`}>
            <td className="px-6 py-5 whitespace-nowrap">
                <div className="flex items-center gap-4">
                    ...
                    <div
                        className={`${isChild ? 'w-8 h-8' : 'w-10 h-10'} rounded-md flex items-center justify-center border-2 border-background shadow-md`}
            ...
            <td className="px-6 py-5 whitespace-nowrap">
                <Badge variant="outline" className="text-[10px] font-bold bg-muted/30 border-none font-mono">
                    {category.slug}
                </Badge>
            </td>
            <td className="px-6 py-5 whitespace-nowrap">
    ...
    return (
        <div className=" animate-fade-in p-2">
            ...
            {/* Header Section */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-card border border-border p-4 rounded-md shadow-soft mb-4">
                ...
                <div className="flex gap-3">
                    <Button
                        ...
                        className='bg-primary hover:bg-primary/90 rounded-md font-bold  shadow-soft'
                    >
            ...
            {/* Filters */}
            <div className="flex flex-col md:flex-row items-center gap-4 bg-card p-4 rounded-md border border-border shadow-soft">
            ...
            {/* Categories List */}
            <div className="bg-card rounded-md border border-border shadow-soft overflow-hidden mt-4">
                {loading ? (
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-border/20 bg-muted/10">
                                    <th className="px-6 py-5 text-[10px] font-bold text-muted-foreground whitespace-nowrap">Category Meta</th>
                                    <th className="px-6 py-5 text-[10px] font-bold text-muted-foreground whitespace-nowrap">Identifier</th>
                                    <th className="px-6 py-5 text-[10px] font-bold text-muted-foreground whitespace-nowrap">Schema</th>
