...
export default function AgentDashboard({ params: paramsPromise }) {
 ...
 <TabsTrigger value="terminal" className="rounded-lg gap-2 text-[11px] font-bold px-4 transition-all">
 <Terminal className="w-3.5 h-3.5" /> TERMINAL
 </TabsTrigger>
 <TabsTrigger value="missions" className="rounded-lg gap-2 text-[11px] font-bold px-4 transition-all">
 <Kanban className="w-3.5 h-3.5" /> MISSIONS
 </TabsTrigger>
 <TabsTrigger value="scheduler" className="rounded-lg gap-2 text-[11px] font-bold px-4 transition-all">
 <Calendar className="w-3.5 h-3.5" /> SCHEDULER
 </TabsTrigger>
 <TabsTrigger value="registry" className="rounded-lg gap-2 text-[11px] font-bold px-4 transition-all">
 <Database className="w-3.5 h-3.5" /> REGISTRY
 </TabsTrigger>
 <TabsTrigger value="approvals" className="rounded-lg gap-2 text-[11px] font-bold px-4 transition-all">
 ...
 />
 <Button size="icon" className="h-10 w-10 rounded-lg bg-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-500/20" onClick={handleSendMessage}>
 ...
 <Button variant="outline" size="sm" className="h-8 text-[10px] font-bold rounded-lg border-indigo-500/20 text-indigo-600">Create Agent</Button>
 </CardHeader>
 <CardContent className="p-0">
 {config?.agents?.map(agent => (
 ...
 <Button variant="outline" size="sm" className="h-8 text-[10px] font-bold rounded-lg border-fuchsia-500/20 text-fuchsia-600">Add Model</Button>
 </CardHeader>
 <CardContent className="p-0">
 {models.map(model => (
