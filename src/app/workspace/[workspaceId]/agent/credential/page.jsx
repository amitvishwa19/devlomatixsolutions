    ...
    return (
        <div className="p-6 space-y-6 animate-fade-in bg-background/50 min-h-screen">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-black tracking-tight uppercase">Agent Connectivity</h1>
                    <p className="text-xs text-muted-foreground font-bold tracking-widest uppercase opacity-60">Secure Gateway Configuration</p>
                </div>
            </div>
                    ...
                    <Card className="border-border/40 bg-card/60 backdrop-blur-md rounded-2xl overflow-hidden shadow-xl shadow-indigo-500/5">
                        <CardHeader className="border-b border-border/10 pb-6">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-3 bg-indigo-500/5 px-4 py-2 rounded-xl border border-indigo-500/10">
                                    <Label htmlFor="claw-toggle" className="text-[10px] font-black uppercase tracking-widest text-indigo-600/70">
                        ...
                        <CardContent className="p-8 space-y-8">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between px-1">
                                    <Label className="text-[10px] font-black tracking-widest uppercase text-muted-foreground">API Endpoint URL</Label>
                                    <Badge variant="outline" className="text-[9px] font-bold h-4 px-1.5 opacity-60 uppercase">REST API</Badge>
                                </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between px-1">
                                    <Label className="text-[10px] font-black tracking-widest uppercase text-muted-foreground">Secret API Key</Label>
                                    <div className="flex items-center gap-1.5">
                                        <Lock className="w-3 h-3 text-emerald-500" />
                                        <span className="text-[9px] font-bold text-emerald-600/70 uppercase">Encrypted</span>
                                    </div>
                                </div>
                                <div className="relative group">
                        ...
                        <CardFooter className="bg-indigo-500/5 p-6 border-t border-border/10 flex items-center justify-between">
                            <Button 
                                ...
                                className="rounded-xl font-black text-[10px] uppercase tracking-widest h-10 px-6 border-indigo-500/20 text-indigo-600 gap-2"
                            >
                            ...
                            <Button 
                                type="submit" 
                                disabled={saving}
                                className="rounded-xl font-black text-[10px] uppercase tracking-widest h-10 px-8 bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-500/20"
                            >
