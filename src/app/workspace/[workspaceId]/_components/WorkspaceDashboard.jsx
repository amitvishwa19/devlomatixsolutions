    ...
    return (
        <div className="space-y-4 pb-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <Card className="lg:col-span-2 border-border/100 bg-card/100 backdrop-blur-sm overflow-hidden">
                ...
                <Card className="border-border/100 bg-card/100 backdrop-blur-sm">
                    <CardHeader>
                        <CardTitle className="text-xl font-bold flex items-center gap-2">
