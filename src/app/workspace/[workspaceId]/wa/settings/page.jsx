...
import { MessageSquare, Shield, Smartphone, RefreshCcw, CheckCircle2, AlertCircle, LogOut, QrCode, Plus, Trash2, Send } from 'lucide-react';
        ...
        <div className="p-2  animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-2">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground">Manage your WhatsApp instance connection and credentials</p>
                </div>
                ...
                <div className="space-y-4 text-white">
                    <Card className="bg-card/50 border-border/50 backdrop-blur-sm">
                        <CardHeader>
                            ...
                            <CardDescription>Saved numbers for quick testing in Builder ({testNumbers.length}/5)</CardDescription>
                        </CardHeader>
