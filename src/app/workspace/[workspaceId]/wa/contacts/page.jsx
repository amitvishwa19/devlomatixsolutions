  ...
  return (
    <>
            <div className=" animate-in fade-in duration-500">
                <div>
                    <h1 className="text-xl font-bold text-white mb-2 tracking-tight">Contacts</h1>
                ...
                className="w-full mt-2">
                    ...
                    <DropdownMenu>
                        ...
                        {/* Bulk Selection Bar */}
                        <div className="flex items-center justify-between py-2 px-3 mb-4 bg-muted/30 rounded-lg border border-border/50">
            ...
            <Dialog open={isGroupModalOpen} onOpenChange={setIsGroupModalOpen}>
                <DialogContent className="max-w-md">
                  ...
                  onChange={(e) => setNewGroup({ ...newGroup, name: e.target.value })} />
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-muted-foreground uppercase text-[10px] tracking-wider">Existing Groups</label>
                            {groups.length === 0 ?
