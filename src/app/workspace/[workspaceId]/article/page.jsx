...
export default function ArticlePage() {
    ...
    return (
        <div className="space-y-4 animate-fade-in">
            ...
            {/* Header Section */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-card/10 p-2  backdrop-blur-sm shadow-sm">
                ...
                <div className="flex items-center gap-3">
                    <Button
                        ...
                        className="rounded-md border-border/60 hover:bg-background text-[10px] font-bold tracking-widest"
                    >
                        <Share2 className="w-4 h-4 mr-2 text-primary" /> Add Credentials
                    </Button>
                    <Button variant="outline" className="rounded-md border-border/60 hover:bg-background text-[10px] font-bold tracking-widest">
                        <Calendar className="w-4 h-4 mr-2 text-primary" /> Calendar
                    </Button>
                    <Button
                        onClick={() => onOpen('addPost', { workspaceId, onApply: fetchPosts })}
                        className="bg-primary hover:bg-primary/90 rounded-md shadow-lg shadow-primary/20 transition-all font-bold px-6 text-[10px] tracking-widest"
                    >
            ...
            {/* Filters & Search */}
            <div className="flex flex-col md:flex-row items-center gap-4 bg-card/20 p-2 rounded-lg border  backdrop-blur-sm shadow-xl shadow-black/5">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center bg-background/50 rounded-lg p-1 border border-border/40">
                        <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => setViewMode('list')}
                            className={cn(
                                "px-3 rounded-md transition-all text-[10px] font-bold tracking-widest uppercase",
                                viewMode === 'list'
                    ...
                    <Button variant="outline" className="px-4 rounded-md border-border/40 bg-background/50">
