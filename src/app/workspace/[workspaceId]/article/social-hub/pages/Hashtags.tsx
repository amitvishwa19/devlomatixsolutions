      ...
      <div className="container mx-auto px-4 py-8 lg:py-12 max-w-4xl">
        <header className="text-center mb-10">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-bold mb-2">
            <span className="gradient-text">Hashtag</span>{" "}
        ...
        {result && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {Object.entries(result.categories).map(([cat, tags]) =>
              tags && tags.length > 0 ? (
                <Card key={cat} className="border-border/50 bg-card/80">
                  <CardHeader className="pb-3">
                    <CardTitle className="text-sm font-medium capitalize text-muted-foreground">{cat}</CardTitle>
                  </CardHeader>
