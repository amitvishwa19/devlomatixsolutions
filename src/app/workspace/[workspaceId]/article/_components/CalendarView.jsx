        ...
        <div className="bg-card/40 backdrop-blur-xl border border-border/40 rounded-xl overflow-hidden shadow-soft animate-fade-in">
            ...
            <div className="grid grid-cols-7 border-b border-border/20">
                {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
                    <div key={day} className="py-3 text-center text-[10px] font-black text-muted-foreground uppercase tracking-widest bg-muted/2">
                        {day}
                    </div>
                ))}
            </div>
                                            ...
                                            <TooltipContent side="right" className="bg-popover border-border animate-in zoom-in-95 p-3 rounded-xl shadow-xl w-64">
                                                <div className="space-y-2">
                                                    <div className="flex items-center justify-between">
                                                        <Badge className={cn(
                                                            "text-[8px] font-black tracking-widest h-4 border-none",
                                                    ...
                                                    <p className="text-xs font-black line-clamp-2 leading-tight">{post.title || "Untitled Post"}</p>
                                                    <div className="flex flex-wrap gap-1">
                                                        {post.platforms?.map(p => (
                                                            <span key={p} className="text-[8px] font-black text-primary uppercase bg-primary/5 px-1 rounded">
                                                                {p}
                                                            </span>
                                                        ))}
                                                    </div>
