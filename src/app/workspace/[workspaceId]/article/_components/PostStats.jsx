            ...
            {stats.map((stat, i) => (
                <div key={i} className={cn(
                    ...
                    <div className="flex items-center justify-between mb-3 relative z-10">
                        ...
                        {stat.isEngagement ? (
                            <Badge variant="outline" className="border-none bg-primary/5 text-primary text-[8px] font-black tracking-widest px-1.5 h-4">
                                LIVE
                            </Badge>
                        ) : (
                            <Badge variant="outline" className="border-none bg-muted/30 text-[8px] text-muted-foreground font-black tracking-widest px-1.5 h-4">
                                SYNCED
                            </Badge>
                        )}
                    </div>
                    ...
                    <div className="relative z-10">
                        <h4 className="text-xl font-black text-foreground tracking-tight flex items-baseline gap-1">
                        ...
                        <p className="text-muted-foreground text-[9px] font-black uppercase tracking-wider opacity-60">
                            {stat.label}
                        </p>
                    </div>
                </div>
