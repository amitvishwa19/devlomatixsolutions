...
export const PostCard = ({ post, onApply }) => {
 ...
 <div className="group flex flex-col bg-card rounded-md border border-border overflow-hidden hover:shadow-medium transition-all shadow-soft animate-fade-in">
 {/* Media Preview */}
 ...
 className="bg-background/90 p-1.5 rounded-md shadow-soft border border-border hover:bg-primary/10 hover:border-primary/30 transition-all disabled:opacity-50 cursor-pointer"
 >
 ...
 <DropdownMenuContent align="end"className="w-48 rounded-md shadow-2xl border-border/100 p-2">
 <DropdownMenuItem 
