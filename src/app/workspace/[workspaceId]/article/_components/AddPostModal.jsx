...
export const AddPostModal = () => {
    ...
    const handleSeoAnalysis = async (isManual = false) => {
        ...
        try {
            ...
            console.error(error);
            if (isManual) toast.error("SEO Analysis failed");
        } finally {
                ...
                <div className="flex flex-col h-full">
                    ...
                    <DialogHeader className="p-4  border-b border-border flex flex-row items-center justify-between shrink-0">
                        ...
                        {/* <div className="flex items-center gap-4">
                            <div className="flex items-center bg-muted/20 p-1 rounded-lg border border-border/10">
                                <Button
                                    type="button"
                                    ...
                                    {seoScore !== null && (
                                        <div className="space-y-4 animate-in fade-in slide-in-from-top-1 duration-500">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-2">
                                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-[11px] font-black ${
                                                        seoScore > 80 ? 'bg-green-500/10 text-green-500' : 
                                            ...
                                            {seoKeywords.length > 0 && (
                                                <div className="space-y-2">
                                                    <p className="text-[9px] font-black text-muted-foreground/60 uppercase tracking-wider">Keywords Found</p>
                                            ...
                                            {seoTips.length > 0 && (
                                                <div className="space-y-2">
                                                    <p className="text-[9px] font-black text-muted-foreground/60 uppercase tracking-wider">Optimization Tips</p>
