...
export const AddPostModal = () => {
    ...
    return (
        <Dialog open={isModalOpen} onOpenChange={handleClose}>
            <DialogContent className="min-w-[98vw] max-w-[98vw] min-h-[98vh] h-[98vh] max-h-[98vh] bg-background border rounded-md shadow-2xl p-0 overflow-hidden flex flex-col">
                    ...
                    <div className="flex-1 flex overflow-hidden">
                        ...
                        <div className="flex-1 flex flex-col p-8 space-y-6 overflow-y-auto scrollbar-hide border-r border-border/10">
                            ...
                            <div className="flex-1 flex flex-col space-y-2 text-left">
                                ...
                                {showAiAssistant && (
                                    <div className="bg-primary/5 border border-primary/20 rounded-md p-4 mb-2 animate-in slide-in-from-top-2 duration-300">
                                        <div className="flex gap-2">
                                            <div className="relative flex-1">
                                                ...
                                                <Input
                                                    ...
                                                    className="pl-10 bg-background border-none text-xs font-medium"
                                                />
                                            </div>
                                            <Button
                                ...
                                <div
                                    className="flex-shrink-0 border border-border/100 rounded-md overflow-hidden focus-within:border-primary/50 transition-colors bg-card/100 shadow-sm relative"
                                ...
                                <div className='mt-8 pt-8 border-t border-border/10'>
                                    ...
                                    <div className="space-y-8">
                                        {selectedPlatforms.map(platform => {
                                            ...
                                            return (
                                                <div key={platform} className="flex flex-col xl:flex-row gap-6 bg-card/50 p-6 rounded-md border border-border/50 shadow-sm animate-in fade-in duration-500">
                                                    {/* Text Editor Column */}
                                                    <div className="w-full xl:w-[60%] flex flex-col space-y-3 relative shrink-0">
                                                        ...
                                                        <div className="flex-1 flex flex-col min-h-[300px] max-h-[500px] overflow-y-auto overflow-x-auto border border-border/50 rounded-md bg-background focus-within:border-primary/50 transition-colors">
                                                            <TipTap data={currentText} onChange={updateContent} />
                                                        </div>
                                                    </div>

                                                    {/* Visual Preview Column */}
                                                    <div className="w-full xl:w-[40%] flex items-start justify-center bg-muted/10 p-6 rounded-md border border-border/10 min-w-0 overflow-y-auto min-h-[300px] max-h-[500px] overflow-x-auto">
                        ...
                        <div className="w-[380px] flex flex-col bg-muted/5 p-8 space-y-3 overflow-y-auto scrollbar-hide">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {accounts.filter(acc => acc.status === 'connected' && ['FACEBOOK', 'INSTAGRAM', 'LINKEDIN', 'X', 'WHATSAPP'].includes(acc.platform?.toUpperCase())).map((account) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`
 flex items-center gap-3 px-4 py-3 rounded-md border-2 transition-all duration-300 text-left w-full
 ${isSelected
                                                        ? 'border-primary bg-primary/5 text-primary shadow-lg shadow-primary/5'
                                                        : 'border-border/100 bg-card/100 text-muted-foreground hover:border-primary/30'}
 `}
                                            >
                                                <div className={`p-2 rounded-md shrink-0 ${isSelected ? 'bg-primary/10' : 'bg-muted/30'}`}>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-card/100 border border-border/100 rounded-md p-4 space-y-4 shadow-sm">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex gap-2">
                                        <Input
                                            ...
                                            className="bg-card/100 border-border/100 rounded-md text-[11px]"
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4 text-left">
                                ...
                                <div className="flex gap-2">
                                    <Input
                                        ...
                                        className="bg-muted/10 border rounded-md text-[11px]"
                                    />
                                    <Button
                                        type="button"
                                        variant="outline"
                                        onClick={handleAddMedia}
                                        className="w-10 rounded-md border-border/20 hover:bg-primary/10 hover:text-primary transition-colors"
                                    >
                                        <Plus className="w-4 h-4" />
                                    </Button>
                                </div>

                                <div className="grid grid-cols-3 gap-2 min-h-[80px] border rounded-md">
                                    {mediaUrls.length > 0 ? (
                                        mediaUrls.map((url, i) => (
                                            <div key={i} className="group relative aspect-square rounded-md overflow-hidden border border-border/100 bg-card/100 shadow-sm animate-in zoom-in-50 duration-300">
