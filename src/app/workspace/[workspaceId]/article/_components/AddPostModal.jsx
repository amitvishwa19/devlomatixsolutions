                  ...
                  <div className="bg-primary/5 border border-primary/20 rounded-md p-4 mb-2 animate-in slide-in-from-top-2 duration-300">
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        className="bg-primary text-primary-foreground h-10 px-4 rounded-md flex items-center gap-2 shadow-lg shadow-primary/20 transition-all font-bold text-[10px]"
                      >
                      ...
                      return (
                        <div key={platform} className="flex flex-col xl:flex-row gap-6 bg-card/50 p-6 rounded-md border border-border/50 shadow-sm animate-in fade-in duration-500">
                          ...
                          <div className="w-full xl:w-[60%] flex flex-col space-y-3 relative shrink-0">
                            ...
                            <div className="flex-1 flex flex-col min-h-[300px] max-h-[500px] overflow-y-auto overflow-x-hidden border border-border/50 rounded-md bg-background focus-within:border-primary/50 transition-colors">
                              <TipTap data={currentText} onChange={updateContent} />
                            </div>
                          </div>
                          
                          {/* Visual Preview Column */}
                          <div className="w-full xl:w-[40%] flex items-start justify-center bg-muted/10 p-6 rounded-md border border-border/10 min-w-0 overflow-y-auto min-h-[300px] max-h-[500px] overflow-x-hidden">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      className="bg-card/100 border-border/100 rounded-md h-10 text-[11px]"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 text-left">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    className="bg-muted/10 border rounded-md h-10 text-[11px]"
                  />
                  <Button
                    type="button"
                    variant="outline"
