            ...
            <DialogContent className="min-w-[85vw] max-w-[85vw] min-h-[85vh] h-[85vh] max-h-[85vh] bg-background border border-border rounded-2xl shadow-2xl p-0 overflow-hidden flex flex-col">
                ...
                <DialogHeader className="px-8 py-5 border-b border-border/40 bg-muted/5 flex flex-row items-center justify-between shrink-0">
                    <div className="space-y-1 text-left">
                        <DialogTitle className="text-xl font-black text-foreground flex items-center gap-3 tracking-tight uppercase">
                            <Sparkles className="text-primary h-5 w-5 animate-pulse-slow" /> Media Hub 2.0
                        </DialogTitle>
                        <p className="text-[10px] font-black text-muted-foreground opacity-40 tracking-widest uppercase">
                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <div className="w-64 border-r border-border/40 bg-muted/2 p-6 flex flex-col gap-6 shrink-0">
                        <div className="space-y-2">
                             <p className="text-[9px] font-black text-muted-foreground/50 tracking-widest uppercase mb-4 px-2">Library View</p>
                             <Button 
                        ...
                        <div className="space-y-4">
                            <p className="text-[9px] font-black text-muted-foreground/50 tracking-widest uppercase px-2">Quick Actions</p>
                            <div className="bg-primary/5 rounded-xl p-4 border border-primary/10 space-y-3">
                                ...
                                <Button size="sm" className="w-full h-8 text-[9px] font-black bg-primary text-primary-foreground rounded-lg shadow-lg shadow-primary/10">
                    ...
                    <div className="flex-1 overflow-hidden relative">
                        {isLoading ? (
                            <div className="h-full flex flex-col items-center justify-center space-y-4">
                                ...
                                <p className="text-[10px] font-black text-primary tracking-widest uppercase animate-pulse">Syncing Cloud Assets...</p>
                            </div>
                            ...
                            <div className="h-full flex flex-col items-center justify-center space-y-4 opacity-40">
                                ...
                                <div className="text-center space-y-1">
                                    <h3 className="text-lg font-black text-foreground">Archive Empty</h3>
                                        ...
                                        >
                                            <div className="aspect-square relative flex items-center justify-center overflow-hidden bg-muted/20">
                                                ...
                                                <div className="absolute top-2 right-2 flex gap-1 transform translate-y-[-200%] group-hover:translate-y-0 transition-transform duration-500">
                                                    ...
                                                    <div className="bg-background/80 backdrop-blur-md text-[8px] font-black p-1 px-1.5 rounded-md border border-border/10 uppercase shadow-sm">
                                            ...
                                            <div className="p-4 bg-background/90 backdrop-blur-xl border-t border-border/10">
                                                <p className="text-[10px] font-black truncate text-foreground group-hover:text-primary transition-colors leading-tight mb-1">
                                                    {doc.name}
                                                </p>
                                                <div className="flex items-center justify-between">
                                                    <span className="text-[8px] font-bold text-muted-foreground/60">{(doc.fileSize / 1024 / 1024).toFixed(2)} MB</span>
                                                    {doc.tags?.length > 0 && (
                                                        <Badge className="h-3 text-[7px] font-black bg-primary/10 text-primary border-none">
                ...
                <DialogFooter className="px-8 py-5 border-t border-border/40 bg-muted/5 flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-4">
                        {selectedUrl && (
                            <div className="flex items-center gap-2 animate-in slide-in-from-left-4">
                                ...
                                <p className="text-[9px] font-black text-primary bg-primary/5 px-3 py-1.5 rounded-lg border border-primary/10 tracking-widest uppercase">
                                    Asset Selected
                                </p>
                            </div>
                        )}
                        <Button
                            ...
                            className="h-10 px-4 text-[10px] font-black text-primary border-primary/30 hover:bg-primary/5 rounded-xl transition-all"
                        >
                    ...
                    <div className="flex items-center gap-4">
                        <Button
                            ...
                            variant="ghost"
                            onClick={handleClose}
                            className="px-6 rounded-xl font-black text-muted-foreground text-[10px] uppercase tracking-widest hover:bg-muted"
                        >
                            Dismiss
                        </Button>
                        <Button
                            ...
                            className="px-10 h-11 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-primary/20 transition-all active:scale-95 disabled:opacity-50"
                        >
                            Embed into Article
                        </Button>
                    </div>
