...
export const MediaLibraryModal = () => {
 ...
 <p className="text-[10px] font-bold text-muted-foreground animate-pulse">Scanning Archive...</p>
 </div>
 ) : filteredDocuments.length === 0 ? (
 <div className="h-full flex flex-col items-center justify-center space-y-4 opacity-40">
 <FolderOpen className="h-16 w-16 text-muted-foreground" />
 <p className="text-[10px] font-bold text-muted-foreground ">No images found in this workspace</p>
 </div>
 ) : (
 ...
 <p className="text-[9px] font-bold truncate text-foreground group-hover:text-primary transition-colors ">
 {doc.name}
 </p>
 </div>
 </div>
 ...
 {selectedUrl && (
 <p className="text-[9px] font-bold text-muted-foreground bg-muted/30 px-3 py-1.5 rounded-md border border-border/10">
 1 Asset Selected
 </p>
 )}
 <Button
