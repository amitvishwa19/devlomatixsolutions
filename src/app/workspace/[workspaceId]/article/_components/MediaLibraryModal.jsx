                    ...
                    <div className="w-72 border-r border-border/40 bg-muted/2 p-6 flex flex-col gap-6 shrink-0 overflow-y-auto">
                        <div className="space-y-4 mb-2">
                            ...
                            <div className="bg-primary/5 rounded-md border border-primary/20 p-5 space-y-4 animate-in zoom-in-95 backdrop-blur-sm">
                                ...
                                <Button
                                    ...
                                    className="w-full bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl text-[9px] h-9 font-black uppercase tracking-widest shadow-lg shadow-primary/20 transition-all active:scale-95"
                                >
                                    {isUploading ? (
                                        <div className="flex items-center gap-2">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-indigo-500/5 rounded-3xl border border-indigo-500/20 p-5 space-y-4 backdrop-blur-sm">
                                ...
                                <Button size="sm" className="w-full h-8 text-[9px] bg-indigo-500 hover:bg-indigo-600 text-white rounded-xl shadow-lg shadow-indigo-500/20 font-black uppercase tracking-widest">
                    ...
                    <div className="flex items-center gap-4">
                        {selectedUrl && (
                            <div className="flex items-center gap-3 animate-in slide-in-from-left-4">
                                <div className="w-10 h-10 rounded-xl overflow-hidden border border-primary/20 shadow-xl relative ring-2 ring-primary/5">
