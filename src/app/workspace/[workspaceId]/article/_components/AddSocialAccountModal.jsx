...
export const AddSocialAccountModal = () => {
 ...
 <label className="text-[10px] font-bold text-muted-foreground opacity-70 ml-1">Platform</label>
 ...
 <label className="text-[10px] font-bold text-muted-foreground opacity-70 ml-1">Access Token</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold text-muted-foreground opacity-70 ml-1">Profile Name (Display Only)</label>
 <Input
 disabled={isLoading}
