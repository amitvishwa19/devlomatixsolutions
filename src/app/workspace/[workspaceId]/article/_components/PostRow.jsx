            ...
            <div className="group flex items-center bg-card rounded-md border border-border overflow-hidden hover:shadow-medium transition-all p-3 gap-4 shadow-soft animate-fade-in">
                ...
                <div className="flex-1 min-w-0 flex items-center justify-between gap-4">
                    <div className="flex-1 min-w-0 w-[40%] flex-wrap">
                        <h4 className="text-sm font-bold text-foreground line-clamp-1 break-all">{post.title || "Untitled Post"}</h4>
                        <p className="text-[10px] text-muted-foreground font-medium line-clamp-2 opacity-70 break-words leading-tight">
