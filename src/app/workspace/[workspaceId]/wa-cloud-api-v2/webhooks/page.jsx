...
export default function WebhooksPage() {
    ...
    return (
        <div className="p-8 h-full flex flex-col items-center justify-center space-y-4 animate-in fade-in duration-500">
            ...
            <h1 className="text-3xl font-bold text-foreground">Webhooks Out</h1>
            <p className="text-muted-foreground text-center max-w-md">
                Configure outbound webhooks to push data to your external systems and third-party integrations.
            </p>
