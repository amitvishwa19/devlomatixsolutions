...
const getStatusBadge = (status) => {
    ...
    const baseClass = "px-3 py-0.5 rounded-full text-[11px] font-black uppercase tracking-widest border-0 flex items-center justify-center min-w-[80px]";
    ...
    return (
        <div className="flex flex-col h-full space-y-6 animate-fade-in w-full p-2">
            ...
            <div className="flex items-start justify-between">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-foreground/90">Documents</h1>
            ...
            {/* Filter & Search Bar */}
            <div className="flex items-center gap-4 bg-card rounded-xl border p-2 shadow-sm">
                <div className="relative flex-1">
                    ...
                    <Input
                        ...
                        className="pl-10 border-0 bg-transparent shadow-none focus-visible:ring-0 text-sm font-medium h-10"
                    />
                </div>
                <div className="w-[1px] h-6 bg-border mx-2" />
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="text-muted-foreground font-semibold px-4 border-0 hover:bg-muted/50 rounded-lg shrink-0">
            ...
            {/* Main Table */}
            <div className="bg-card rounded-2xl border shadow-sm flex-1 overflow-hidden flex flex-col">
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse min-w-[800px]">
                        <thead>
                            <tr className="border-b bg-muted/20 text-xs uppercase tracking-widest text-muted-foreground/80 font-black">
                            ...
                            {loading ? (
                                <tr>
                                    <td colSpan={8} className="p-10 text-center text-muted-foreground">
                                        <div className="flex flex-col items-center gap-3">
                                            ...
                                            <span className="text-xs uppercase tracking-widest font-black">Loading Database...</span>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colSpan={8} className="p-16 text-center">
                                        <p className="text-muted-foreground font-bold tracking-tight">No files found matching criteria.</p>
                                    </td>
                                </tr>
                            ) : (
                                filteredFiles.map((f) => (
                ...
                <DialogContent className="sm:max-w-md rounded-2xl border-none shadow-2xl">
                    <DialogHeader className="mb-4">
                        ...
                        <DialogDescription className="font-medium">
                            Choose an existing folder or create a new one to move <span className="text-foreground tracking-tight underline decoration-primary/50 underline-offset-2">{fileToMove?.length === 1 ? fileToMove[0].name : `${fileToMove?.length} files`}</span>
                        </DialogDescription>
                    </DialogHeader>

                    <div className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-muted-foreground ml-1">Select Existing Folder</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-muted-foreground ml-1">Create New Folder</label>
