        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md rounded-2xl border-none shadow-2xl overflow-hidden p-0">
                <div className="p-6 pb-4">
                    <DialogHeader className="mb-4">
                        ...
                        <DialogDescription className="font-medium">
                            Invite workspace members to collaborate on <span className="text-foreground tracking-tight font-bold">{document.name}</span>
                        </DialogDescription>
                    </DialogHeader>
                ...
                <div className="bg-muted/20 px-6 py-4 border-t border-border/40">
                    <h4 className="text-xs font-black tracking-widest uppercase text-muted-foreground mb-4">People with access</h4>
                            ...
                            return (
                                <div key={access.id} className="flex items-center justify-between group">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="text-xs font-bold tracking-tight text-foreground/70 uppercase">{access.role}</span>
                                        <Button 
                                            variant="ghost" 
                                            size="icon" 
