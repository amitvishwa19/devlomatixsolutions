...
export default function FileViewerModal({ isOpen, onOpenChange, file }) {
 ...
 <p className="text-xs text-muted-foreground/60 max-w-[280px] text-center mb-6 font-medium">
 ...
 <div className="w-10 rounded-md bg-primary/10 flex items-center justify-center shrink-0 border border-primary/20">
