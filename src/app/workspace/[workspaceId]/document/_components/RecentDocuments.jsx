        ...
        return (
            <Card className="lg:col-span-2 shadow-sm animate-fade-up min-h-[400px] flex items-center justify-center border border-border/100 bg-card/100">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-xs font-black text-muted-foreground uppercase tracking-widest">Fetching data...</p>
                </div>
            </Card>
        );
    }
        ...
        <Card className="lg:col-span-2 shadow-sm animate-fade-up overflow-hidden border border-border/100 bg-card/100" style={{ animationDelay: "350ms" }}>
            <CardHeader className="pb-4 border-b border-border/10 bg-muted/5">
                <div className="flex items-center justify-between">
                    <CardTitle className="text-sm font-black uppercase tracking-widest text-muted-foreground">Recent Documents</CardTitle>
                    <Badge variant="outline" className="text-[10px] font-black uppercase tracking-tighter bg-background">Last 5 Assets</Badge>
                </div>
            </CardHeader>
            <CardContent className="px-0">
                {recentDocs.length === 0 ? (
                    <div className="py-20 flex flex-col items-center justify-center opacity-40">
                        ...
                        <p className="text-sm font-bold text-muted-foreground uppercase tracking-widest">No recent files</p>
                    </div>
                ) : (
                            ...
                            >
                                <div className="flex items-center gap-5 min-w-0">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider opacity-60 flex items-center gap-2">
                                ...
                                <div className="flex items-center gap-6 shrink-0">
                                    <Badge
                                        ...
                                        variant="outline"
                                        className={`${statusStyles[doc.status?.toLowerCase()] || statusStyles.approved} text-[9px] font-black uppercase tracking-widest px-2.5 py-1 border-none shadow-sm cursor-pointer hover:opacity-80 transition-opacity`}
                                        title="Click to change Status"
                                    >
                                        {doc.status || "APPROVED"}
                                    </Badge>
                                    <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest opacity-40 hidden sm:block w-24 text-right tabular-nums italic">
