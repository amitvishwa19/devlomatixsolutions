        ...
        <div className="space-y-4 h-full overflow-y-auto p-2">
            ...
            {isLoading && trashItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-32 space-y-4">
                    ...
                    <p className="text-sm font-black text-muted-foreground uppercase tracking-[0.2em] animate-pulse">Loading Trash...</p>
                </div>
            ) : trashItems.length === 0 ? (
                ...
                <div className="bg-background/50 rounded-2xl border border-border/40 shadow-sm overflow-hidden animate-fade-up">
                            ...
                            <div key={item.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 hover:bg-muted/30 transition-colors group">
                                <div className="flex items-center gap-4 min-w-0">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider opacity-70 mt-0.5">
                                ...
                                <div className="flex items-center gap-2 mt-4 sm:mt-0 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                                    <Button
                                        ...
                                        className="h-9 px-4 rounded-xl font-bold bg-background text-foreground hover:bg-muted"
                                    >
