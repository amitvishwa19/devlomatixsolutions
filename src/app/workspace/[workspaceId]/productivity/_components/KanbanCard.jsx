                    ...
                    <div className="space-y-3">
                        ...
                        {task.checklists && task.checklists.length > 0 && (
                            <div className="space-y-1.5 pt-1">
                                <div className="flex items-center justify-between text-[8px] font-bold text-muted-foreground tracking-widest uppercase">
                                    <span>Progress</span>
                                    <span>
                            ...
                            {task.assignee && (
                                <TooltipProvider>
                                    <Tooltip>
                                        ...
                                        <TooltipContent side="top" className="bg-background/95 backdrop-blur-md border px-3 py-1.5 rounded-lg shadow-xl">
                                            <p className="text-[10px] font-bold tracking-tight">{task.assignee.displayName}</p>
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                            )}
