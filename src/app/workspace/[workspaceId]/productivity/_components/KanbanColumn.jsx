...
export const KanbanColumn = ({ column, tasks, onCreateTask, onDeleteColumn, onDeleteTask, onUpdateTask }) => {
 return (
 <div className="flex-shrink-0 w-80 h-full flex flex-col bg-muted/20 rounded-md border border-border/10 overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md">
 {/* Column Header */}
