...
export const AddKanbanTaskModal = () => {
  ...
  const onGenerateDescription = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/workspace/${workspaceId}/productivity/ai/generate-description`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        body: JSON.stringify({ title, type: taskType })
      });
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between ml-1">
                      <label className="text-[10px] text-muted-foreground flex items-center gap-1.5 opacity-70">
                      ...
                      <Button
                        ...
                        className="h-6 px-2 text-[9px] font-bold gap-1.5 hover:bg-primary/10 hover:text-primary transition-all rounded-md group"
                      >
                        {isGeneratingAI ? (
