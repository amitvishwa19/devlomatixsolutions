                ...
                <form onSubmit={onSubmit} className="flex flex-col">
                        ...
                        <div className="flex items-center justify-between gap-3 mb-2">
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <Button variant="outline" size="sm" className="h-8 rounded-lg text-[10px] font-bold tracking-widest gap-2">
                                        <ImageIcon size={14} /> 
                                ...
                                <PopoverContent align="end" className="w-[340px] p-0 border-none shadow-2xl">
                                    <div className="p-4 bg-background rounded-xl border border-border/40">
                                        <h4 className="text-[10px] font-black uppercase tracking-[0.2em] mb-4 text-muted-foreground">Select a Cover Image</h4>
                                        <UnsplashImagePicker 
                    ...
                    <Tabs defaultValue="details" className="w-full px-8">
                        <TabsList className="grid w-full grid-cols-3 h-11 bg-muted/20 p-1 rounded-xl mb-6">
                            <TabsTrigger value="details" className="rounded-lg text-[10px] font-bold tracking-widest uppercase data-[state=active]:bg-background data-[state=active]:shadow-sm">
                                <Briefcase className="w-3.5 h-3.5 mr-2" /> Details
                            </TabsTrigger>
                            <TabsTrigger value="checklist" className="rounded-lg text-[10px] font-bold tracking-widest uppercase data-[state=active]:bg-background data-[state=active]:shadow-sm">
                                <CheckSquare className="w-3.5 h-3.5 mr-2" /> Checklist
                            </TabsTrigger>
                            <TabsTrigger value="activity" className="rounded-lg text-[10px] font-bold tracking-widest uppercase data-[state=active]:bg-background data-[state=active]:shadow-sm">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Select value={taskType} onValueChange={setTaskType} disabled={isLoading}>
                                                ...
                                                <SelectContent className="rounded-xl border-border/40">
                                                    ...
                                                    <SelectItem value="note" className="font-bold rounded-lg text-amber-500">Note/Draft</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                        <div className="space-y-2">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Select value={priority} onValueChange={setPriority} disabled={isLoading}>
                                                ...
                                                <SelectContent className="rounded-xl border-border/40 font-bold">
                                                    ...
                                                    <SelectItem value="urgent" className="text-rose-600 rounded-lg">Urgent</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        {checklists.length === 0 ? (
                                            <div className="py-12 border-2 border-dashed border-border/20 rounded-2xl flex flex-col items-center justify-center text-muted-foreground opacity-40">
                                                ...
                                                <p className="text-[10px] font-black uppercase tracking-widest">No sub-tasks yet</p>
                                            </div>
                                        ) : (
                                            checklists.map((item) => (
                                                <div key={item.id} className="group flex items-center gap-3 p-3 bg-muted/20 border border-border/10 rounded-xl hover:border-primary/20 transition-all">
                                                    <Checkbox 
                                                        ...
                                                        className="h-5 w-5 rounded-lg border-2 border-primary/20 bg-background data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground"
                                                    />
                                                    <span className={cn(
                                                ...
                                                <div key={act.id} className="relative flex items-start gap-3">
                                                    ...
                                                    <div className="flex-1 space-y-1">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="text-[8px] font-bold text-muted-foreground tracking-tighter uppercase opacity-50">
