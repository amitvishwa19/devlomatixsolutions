        ...
        <div className="relative mb-12 group">
          ...
          <div className="relative bg-card/10 backdrop-blur-3xl border border-white/5 p-12 rounded-[4rem] shadow-2xl flex flex-col items-center max-w-md text-center group-hover:bg-card/20 transition-all">
            ...
            <Button
              ...
              className="w-full h-16 rounded-3xl bg-primary hover:bg-primary/90 text-primary-foreground font-black text-[10px] tracking-[0.3em] shadow-2xl shadow-primary/20 transition-all hover:scale-[1.02] active:scale-95 uppercase"
            >
