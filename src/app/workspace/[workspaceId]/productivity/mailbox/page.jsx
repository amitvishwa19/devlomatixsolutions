...
export default function MailboxPage() {
 ...
 <h1 className="text-3xl font-extrabold mb-4">Connect your Gmail</h1>
 ...
 className="w-full h-16 rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground font-extrabold text-xs tracking-[0.2em] shadow-xl shadow-primary/20 transition-all hover:scale-[1.02] active:scale-95"
 >
 ...
 <div className="flex items-center gap-2 text-[10px] font-bold "><RefreshCw className="w-3 h-3" /> Real-time sync</div>
 <div className="flex items-center gap-2 text-[10px] font-bold "><Settings className="w-3 h-3" /> Secure OAuth</div>
 </div>
