    ...
    return (
        <div className="w-64 h-full flex flex-col bg-card/10 backdrop-blur-md border-r border-border/40 p-4 space-y-6">
                ...
                {accounts.length > 0 ? (
                    <div className="space-y-4">
                                    ...
                                    <div className="p-2 space-y-1">
                                        {accounts.map((account) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-col min-w-0">
                                                    <span className="text-[11px] font-extrabold truncate leading-tight">{account.email}</span>
                                                    <span className="text-[9px] text-primary font-black mt-0.5 uppercase tracking-tighter">Gmail Account</span>
                                                </div>
                        ...
                        <div className="animate-in fade-in slide-in-from-top-2 duration-700">
                            ...
                            >
                                <SelectTrigger className="w-full bg-muted/30 border-none rounded-xl h-12 font-extrabold text-[10px] tracking-wider focus:ring-1 focus:ring-primary/50 shadow-inner text-left">
                                ...
                                <SelectContent className="rounded-2xl border-border/20 shadow-2xl backdrop-blur-xl">
                                    ...
                                    <SelectItem 
                                        value="ADD_ACCOUNT" 
                                        className="font-black text-[10px] py-3 tracking-wide text-primary hover:bg-primary/10 focus:bg-primary/10 focus:text-primary transition-colors cursor-pointer"
                                    >
                                        <div className="flex items-center gap-2">
            ...
            <div className="pt-6 border-t border-border/20 flex-1 min-h-0 flex flex-col">
                <h3 className="px-3 text-[10px] font-bold text-muted-foreground tracking-[0.2em] mb-4 opacity-50 shrink-0">User Labels</h3>
