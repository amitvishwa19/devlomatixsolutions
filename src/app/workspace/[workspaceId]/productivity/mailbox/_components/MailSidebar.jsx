                        ...
                        {folders.map((folder) => {
                            ...
                            return (
                                <Button
                                    ...
                                    className={cn(
                                        "w-full justify-start gap-3 h-10 px-3 rounded-md transition-all font-bold text-[11px] ",
                                        isActive
                        ...
                        <div className="space-y-1">
                            {userLabels.length > 0 ? userLabels.map(label => (
                                <Button
                                    ...
                                    className={cn(
                                        "w-full justify-start gap-3 h-10 px-3 rounded-md text-[10px] font-bold transition-all",
