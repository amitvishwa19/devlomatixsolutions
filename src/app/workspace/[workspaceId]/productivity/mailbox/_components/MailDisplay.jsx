...
export const MailDisplay = ({ messageId, accountId, onAction }) => {
 ...
 <h3 className="text-sm font-extrabold mb-2">Select a message</h3>
 ...
 <Button variant="ghost" size="sm" onClick={handleReply} className="h-9 px-3 rounded-xl gap-2 font-bold text-[10px] tracking-wider hover:bg-primary/10">
 <Reply className="w-3.5 h-3.5" /> Reply
 </Button>
 <Button variant="ghost" size="sm" onClick={handleForward} className="h-9 px-3 rounded-xl gap-2 font-bold text-[10px] tracking-wider hover:bg-primary/10">
 ...
 className="h-9 px-3 rounded-xl gap-2 font-bold text-[10px] tracking-wider hover:bg-primary/10 text-primary shadow-sm hover:shadow-md transition-all active:scale-95"
 >
 ...
 <span key={label} className="text-[9px] font-black px-2.5 py-1 rounded-full bg-primary/10 text-primary border border-primary/20 shadow-sm">
 {label}
 </span>
 ))}
 </div>
 <h1 className="text-3xl font-black leading-[1.1] text-foreground/95">
 {message.subject}
 </h1>
 ...
 <span className="text-[9px] font-black text-primary/80 bg-primary/10 px-2.5 py-1 rounded-lg border border-primary/10">Sender</span>
 </div>
 ...
 <span className="block text-[10px] font-black text-muted-foreground tracking-[0.2em] opacity-40">Sent On</span>
 ...
 <h4 className="text-[10px] font-black tracking-[0.3em] text-primary">AI Bottom Line</h4>
 </div>
 ...
 <h4 className="text-[10px] font-black tracking-[0.3em] text-primary flex items-center gap-2">
 ...
 <Button size="sm" onClick={sendResponse} className="rounded-xl font-extrabold px-8 bg-primary hover:bg-primary/90 text-[10px] shadow-lg shadow-primary/20">
 Send Message
 </Button>
 </div>
 </div>
 ...
 <Button size="sm" onClick={handleReply} className="h-8 px-5 rounded-xl text-[10px] font-black bg-primary hover:bg-primary/90 shadow-lg shadow-primary/10">Send</Button>
 </div>
 </div>
 </div>
 </div>
