...
export const MailList = ({
 ...
 className="pl-10 bg-muted/30 border-white/5 rounded-md focus-visible:ring-1 focus-visible:ring-primary shadow-inner font-bold text-[11px] tracking-wide"
 />
 </div>
 <Button
 variant="ghost"
 ...
 onClick={onRefresh}
 disabled={loading}
 className="w-10 rounded-md hover:bg-primary/10 hover:text-primary transition-all border border-transparent hover:border-primary/20"
 >
 ...
 <Loader2 className="w-10 animate-spin text-primary"/>
