...
export const MailList = ({
 ...
 className="pl-10 h-10 bg-muted/40 border-none rounded-xl focus-visible:ring-1 focus-visible:ring-primary shadow-inner font-bold text-[11px] "
 />
 </div>
 <Button
 variant="ghost"
 ...
 <span className="text-[10px] font-bold ">Syncing your inbox...</span>
 </div>
 ) : messages.length === 0 ? (
 <div className="flex flex-col items-center justify-center h-64 text-muted-foreground opacity-50">
 <Inbox className="w-12 h-12 mb-4" />
 <span className="text-[10px] font-bold ">No messages found</span>
 </div>
 ) : (
 <div 
 style={{
