    ...
    return (
      <div className="flex flex-col items-center gap-1.5 cursor-pointer group">
        <div className="relative">
          <div
            className={`w-[72px] h-[72px] rounded-2xl border bg-card flex items-center justify-center transition-all
      ...
      <div className="flex flex-col items-center cursor-pointer group">
        <div
          className={`relative rounded-xl border bg-card transition-all min-w-[200px]
            ${selected ? "ring-[1px] ring-primary border-primary" : `${borderClass} hover:shadow-lg`}
          `}
        >
          <Handle
            type="target"
          ...
          {AGENT_SLOTS.map((slot) => {
            ...
            return (
              <div key={slot.id} className="flex flex-col items-center relative">
                ...
                <button
                  onClick={(e) => { e.stopPropagation(); nodeData.onSlotAdd?.(slot.id); }}
