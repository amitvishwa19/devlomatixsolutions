                ...
                <div className="p-8 pb-4">
                    ...
                    <div className="space-y-6 py-8">
                        ...
                        <div className="space-y-2 text-left">
                            <Label className="text-[10px] font-bold tracking-widest text-muted-foreground ml-1">Share Link</Label>
                            <div className="flex items-center space-x-2">
                                <div className="relative flex-1">
                                    <Input
                                        ...
                                        className="bg-muted/30 border-none rounded-md h-12 text-[10px] font-bold tracking-widest text-foreground shadow-inner focus-visible:ring-0 truncate"
                                    />
                                </div>
                                <Button 
                                    size="icon" 
                            ...
                            <Button 
                                variant="link" 
                                size="sm" 
                                className="text-[9px] text-muted-foreground hover:text-primary px-0 h-auto font-bold tracking-widest"
                        ...
                        {/* Option 2: Send Email */}
                        <div className="space-y-2 text-left">
                            <Label className="text-[10px] font-bold tracking-widest text-muted-foreground ml-1">Send Email Invitation</Label>
                            <div className="flex space-x-2">
                                ...
                                <Button 
                                    ...
                                    className="rounded-md shadow-lg shadow-primary/20 bg-primary hover:bg-primary/90 h-12 px-6 font-bold tracking-widest text-[10px]"
                                >
