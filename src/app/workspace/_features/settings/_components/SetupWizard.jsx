...
export default function SetupWizard({ title, description }) {
    ...
    return (
        <div className='flex flex-col gap-2 absolute inset-0 overflow-hidden' >
            ...
            <div className='p-2'>
                <div className='flex flex-row justify-between items-center'>
                    <div className='py-4 px-2 flex flex-col'>
                        ...
                        <span className='text-xs text-muted-foreground'>Application setup and configuration wizard.</span>
                    </div>
            ...
            <ScrollArea className='flex flex-col gap-6 h-full relative' >

                {/* Header with Logo */}
                <div className="flex flex-row items-center justify-evenly w-full ">
                    {steps.map((step, index) => (
                        <div key={step.id} className="flex items-center flex-shrink-0 cursor-pointer" onClick={() => { setCurrentStep(index + 1) }}>
                            ...
                            {index < steps.length - 1 && (
                                <div className={cn(
                                    "w-8 h-0.5 mx-1 transition-colors flex-shrink-0 mb-4",
                ...
                {/* Step Content */}
                <div className="p-4 mt-10  h-full  flex-1 overflow-y-auto">
                    ...
                    {currentStep === 1 && (
                        <div className="space-y-5 animate-fade-in">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <Label htmlFor="emergencyPhone" className="text-foreground">Emergency Number</Label>
                                    <div className="relative mt-1.5">
                ...
                {/* Footer */}
                <div className="p-4 h-20 border-t bg-secondary/20 flex items-center justify-between absolute bottom-0 right-0 left-0 w-full">
                    <Button
                        variant="ghost"
                        onClick={handleBack}
