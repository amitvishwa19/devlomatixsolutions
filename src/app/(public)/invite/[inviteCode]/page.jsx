    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
        <div className="bg-card/50 backdrop-blur-xl border border-white/10 p-8 rounded-3xl max-w-md w-full text-center shadow-2xl">
          ...
          <h1 className="text-2xl italic tracking-tight mb-2">Invalid Invite</h1>
      ...
      <div className="bg-card/60 backdrop-blur-2xl border border-white/10 p-10 rounded-[2rem] max-w-md w-full relative z-10 shadow-2xl space-y-8 animate-fade-in-up">
        <div className="space-y-4 text-center">
          ...
          <div>
            ...
            <h1 className="text-3xl italic tracking-tight text-foreground">{server.name}</h1>
            {server.description && (
        ...
        <div className="space-y-3">
          <Button asChild className="w-full text-md h-12 rounded-xl shadow-lg shadow-primary/20 hover:scale-[1.02] transition-transform">
            <Link href="/login">
