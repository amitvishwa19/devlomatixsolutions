  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <span className="text-primary text-sm font-medium tracking-wider">Tech Stack</span>
        ...
        >
          {technologies.map((tech, index) => (
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="px-5 py-3 rounded-xl bg-secondary/50 border border-border/50 hover:border-primary/50 hover:bg-secondary transition-all duration-300 cursor-pointer"
            >
              <motion.span 
