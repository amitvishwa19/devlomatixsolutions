...
const WhyChooseUs = () => {
    return (
        <section id="why-choose-us" className="py-32 relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-tl from-accent/5 via-background to-primary/5 dark:from-card/30 dark:via-card/30 dark:to-card/30" />
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <h2 className="font-display text-4xl md:text-5xl font-bold mt-4 mb-6 text-primary">
                            Your Success Is <span className="">Our Priority</span>
                        </h2>
                        ...
                        <div className="grid grid-cols-3 gap-6">
                            <div className="text-center">
                                <div className="font-display text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">98%</div>
                                <div className="text-sm text-muted-foreground">Client Retention</div>
                            </div>
                            <div className="text-center">
                                <div className="font-display text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">4.9</div>
                                <div className="text-sm text-muted-foreground">Avg Rating</div>
                            </div>
                            <div className="text-center">
                                <div className="font-display text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">2x</div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {features.map((feature, index) => (
                            ...
                            >
                                <motion.div
                                    className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center mb-3"
