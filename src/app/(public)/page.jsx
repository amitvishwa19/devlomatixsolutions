...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-background mesh-bg w-full ">
            ...
            <section className="p-12 border-y border-border/30 overflow-hidden">
            ...
            {/* How It Works */}
            <section id="how-it-works" className="p-24">
                <div className="  ">
                    <RevealSection>
                        <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            {/* Comparison Table */}
            <section id="comparison" className="p-24">
                <div className="  ">
                    <RevealSection>
                        <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            {/* Testimonials */}
            <section id="testimonials" className="p-24">
                <div className="  ">
                    <RevealSection>
                        <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            {/* Team Section */}
            <section id="team" className="p-24">
                <div className="  ">
                    <RevealSection>
                        <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            {/* Pricing */}
            <section id="pricing" className="p-24">
                <div className="  ">
                    <RevealSection>
                        <div className="mx-auto mb-16 max-w-2xl text-center">
