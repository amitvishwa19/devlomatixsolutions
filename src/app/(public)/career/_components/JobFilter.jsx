        ...
        <div className="space-y-6">
            ...
            {isFiltered && (
                <div className="flex items-center gap-3 animate-in fade-in slide-in-from-top-2">
                    <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground opacity-40">Active Filters</p>
                    <div className="flex flex-wrap gap-2">
                        ...
                        <Button
                            ...
                            size="sm"
                            onClick={handleReset}
                            className="h-6 p-0 text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors"
                        >
                            Reset All
                        </Button>
                    </div>
