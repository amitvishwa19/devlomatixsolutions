                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center space-y-8">
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/5"
                        >
                        ...
                        >
                            <Button
                                ...
                                className="h-14 px-10 rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground font-black uppercase tracking-widest text-xs shadow-xl shadow-primary/20 transition-all active:scale-95"
                            >
                                View Openings
                ...
                <div className="container mx-auto px-6 text-center space-y-16">
                    <div className="max-w-3xl mx-auto space-y-6">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-500 text-[10px] font-black uppercase tracking-widest"
                        >
                            Our Vision
                        </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            >
                                ...
                                <h4 className="text-xl font-black mb-3">{value.title}</h4>
                            ...
                            {filteredJobs.length === 0 && (
                                ...
                                >
                                    ...
                                    <div className="text-center">
                                        <h4 className="text-xl font-black">No positions found</h4>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto p-12 md:p-20 rounded-[40px] bg-gradient-to-br from-primary/5 via-background to-primary/10 border border-primary/20 relative overflow-hidden text-center space-y-10 group">
                        ...
                        <div className="relative z-10">
                            <Button
                                size="lg"
                                className="h-14 px-12 rounded-2xl bg-foreground text-background hover:bg-foreground/90 font-black uppercase tracking-widest text-[10px] transition-all group-hover:scale-105 active:scale-95"
                                onClick={() => handleApply({
                                    id: 'custom',
