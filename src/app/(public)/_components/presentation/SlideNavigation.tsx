...
const SlideNavigation = ({
  ...
  return (
    <>
      ...
      <motion.button
        onClick={onPrev}
        className={`fixed left-6 top-1/2 -translate-y-1/2 z-50 p-3 rounded-full glass-dark transition-all ${
      ...
      <motion.button
        onClick={onNext}
        className={`fixed right-6 top-1/2 -translate-y-1/2 z-50 p-3 rounded-full glass-dark transition-all ${
