...
export function PatientsSettings() {
  ...
  // const { execute: saveToSupabase, isLoading } = useAction(upsertPatientsSettingSupabase, {
  //   onSuccess: (data) => {
  ...
  const onSubmit = async (data) => {
    const toastId = toast.loading("Saving patient settings...");
    try {
      console.log("Patients settings:", data);
      ...
      //     idNumberLength: data.idNumberLength,
      //     autoGenerateId: data.autoGenerateId,
      //     requirePhotoUpload: data.requirePhotoUpload,
      //     smsNotifications: data.smsNotifications,
      //     recordRetentionPeriod: data.recordRetentionPeriod,
      //     defaultBloodType: data.defaultBloodType,
      //     requireConsentForm: data.requireConsentForm,
      //     hipaaComplianceMode: data.hipaaComplianceMode,
      //   }
      // });
      // ============================================

      await new Promise(resolve => setTimeout(resolve, 500));
      toast.success("Patient settings saved successfully", { id: toastId });
    } catch (error) {
