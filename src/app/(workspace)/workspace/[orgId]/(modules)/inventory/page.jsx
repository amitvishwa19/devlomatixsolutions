...
import {
    ...
    Bell, RefreshCw, History
} from 'lucide-react';
import { mockInventoryItems, mockStockMovements } from './utils';
import {
    InventoryStatsCards,
    InventoryFilters,
    InventoryList,
    ...
    return (
        <div className='absolute inset-0 flex flex-col gap-2'>
            ...
            <ContentTopbar
                ...
                description='Track and manage your hospital inventory'
                icon='blocks'
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsList className="flex-wrap h-auto p-2">
