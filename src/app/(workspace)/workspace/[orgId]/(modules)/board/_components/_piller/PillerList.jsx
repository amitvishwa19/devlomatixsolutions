...
import { createPiller } from '@/app/(workspace)/workspace/[orgId]/(modules)/board/_actions/_list/create_piller'
import { updatePiller } from '@/app/(workspace)/workspace/[orgId]/(modules)/board/_actions/_list/update_piller '
...
import { deletePiller } from '@/app/(workspace)/workspace/[orgId]/(modules)/board/_actions/_list/delete_piller '
import { copyPiller } from '@/app/(workspace)/workspace/[orgId]/(modules)/board/_actions/_list/copy_piller'
