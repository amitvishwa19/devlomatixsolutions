...
import { getInitials, getStatusColor } from '../utils/utils';
import { PATIENT_STATUSES } from '../utils/types';
// import {
//   VitalsTab,
//   PrescriptionsTab,
//   MedicalHistoryTab,
...
import { QuickActionButtons } from '../../utils';
...
export function PatientDetailSheet({ patient, open, onOpenChange, onUpdatePatient }) {
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="sm:max-w-[650px] p-2 flex flex-col bg-transparent border-0">
                <div className='border bg-card rounded-lg overflow-hidden h-full'>
