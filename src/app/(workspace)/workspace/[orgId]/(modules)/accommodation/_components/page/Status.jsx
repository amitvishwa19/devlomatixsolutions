...
export default function Status() {
    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                <h2 className=" font-bold text-foreground tracking-tight">Live Status</h2>
                <p className="text-muted-foreground mt-1 text-xs">Real-time floor-wise bed availability</p>
            </div>
                ...
                {[1, 2, 3, 4].map((floor) => {
                    ...
                    return (
                        <div key={floor} className="animate-fade-in" style={{ animationDelay: `${floor * 100}ms` }}>
                            ...
                            <div className="bg-card rounded-2xl border border-border p-4 shadow-card overflow-x-auto">
