...
import { APPOINTMENT_STATUSES, TIME_SLOTS } from '../misc/types';
                      ...
                      <Droppable key={droppableId} droppableId={droppableId}>
                        {(provided, snapshot) => (
                          <div
                            ...
                            className={`min-h-[60px] p-1 border-r border-border last:border-r-0 transition-colors ${isToday ? 'bg-primary/5' : ''
                                ...
                                <Draggable key={apt.id} draggableId={apt.id} index={index}>
                                  {(provided, snapshot) => (
                                    <div
                                      ...
                                      className={`p-2 mb-1 rounded-md border cursor-pointer transition-shadow ${statusStyles[apt.status]
