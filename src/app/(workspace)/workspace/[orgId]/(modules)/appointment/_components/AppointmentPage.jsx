...
import { format, isToday, isYesterday, isTomorrow, isThisWeek, isThisMonth, parse } from "date-fns";
  ...
  return (
    <div className="min-h-screen bg-background p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-muted-foreground">
            {todayAppointments} appointments today • {appointments.length} total
          </p>
        </div>
            ...
            {filteredAppointments.length === 0 ? (
              <div className="glass-effect rounded-2xl p-16 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  {searchQuery ? "Try adjusting your search terms" : "Get started by creating your first appointment"}
                </p>
                <Button
                  onClick={() => {
                    setEditingAppointment(null);
      ...
      <DeleteConfirmDialog
        ...
        appointmentName={appointmentToDelete?.doctorName}
      />
    </div>
  );
}
