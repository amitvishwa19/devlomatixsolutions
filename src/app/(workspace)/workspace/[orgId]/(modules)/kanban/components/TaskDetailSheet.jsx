...
import { PRIORITY_CONFIG, TASK_TYPE_CONFIG, COLUMN_CONFIG } from '../utils/types';
...
export function TaskDetailSheet({
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="w-full sm:max-w-lg p-2 border-0 bg-transparent min-w-[620px]">
                <div className="flex flex-col bg-card rounded-lg border h-full overflow-hidden">
