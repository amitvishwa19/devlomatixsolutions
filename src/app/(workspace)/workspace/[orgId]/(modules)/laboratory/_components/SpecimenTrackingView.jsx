                                                    ...
                                                    return (
                                                        <div key={step} className="flex items-center flex-1">
                                                            <div className="flex flex-col items-center">
                                                                ...
                                                                <span className={`text-xs mt-1 ${isCompleted || isCurrent ? 'text-foreground' : 'text-muted-foreground'
                                                                    }`}>
                                                                    {config.label}
                                                                </span>
                                                            </div>
                                                            {index < statusSteps.length - 2 && (
                                                                <div className={`flex-1 h-0.5 mx-2 ${isCompleted ? 'bg-primary' : 'bg-muted-foreground/30'
                                                                    }`} />
                                                            )}
                                                        </div>
                                                    );
