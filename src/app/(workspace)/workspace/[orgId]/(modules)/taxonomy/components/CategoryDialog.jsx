...
import { TAG_COLORS, ENTITY_TYPES, CATEGORY_ICONS } from '../misc/types';
...
export function CategoryDialog({ open, onOpenChange, category, categories, onSave }) {
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="sm:max-w-lg min-w-[620px] bg-transparent border-0 p-2">
                <div className='h-full rounded-lg bg-card p-2 overflow-hidden'>
                    <SheetHeader>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit, showValidationErrors)} className="flex flex-col h-full">
                            <ScrollArea className=" mt-6 h-[75vh]">
