...
import { CategoryCard, CategoryDialog, TagCard, TagDialog, TaxonomyFilters, TaxonomyStats } from './components';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import { FolderTree, Plus, Tag, Tags } from 'lucide-react';
...
export default function TaxonomyPage() {
    ...
    return (
        <div className='absolute inset-0 flex flex-col gap-2'>
            ...
            <ContentTopbar
                title='Taxonomy'
                description='Manage category and tags across application'
                icon='tags'
            />
