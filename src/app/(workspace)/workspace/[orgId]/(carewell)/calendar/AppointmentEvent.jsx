...
import { APPOINTMENT_STATUSES, APPOINTMENT_TYPES } from '@/carewell/appointment/types';
...
export function AppointmentEvent({ appointment, compact = false, onViewDetails }) {
  ...
  const EventContent = () => (
    <div
      className={`rounded-md border cursor-pointer transition-all ${statusStyles[appointment.status]} ${
