...
export function RecordPaymentSheet({ invoice, open, onOpenChange, onRecordPayment }) {
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    onClick={() => form.setValue('amount', invoice.balanceDue)}
                  >
                    Full
                  </Button>
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    onClick={() => form.setValue('amount', Math.round(invoice.balanceDue / 2))}
                  >
                    Half
                  </Button>
                  <Button
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Staff name - Department" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
