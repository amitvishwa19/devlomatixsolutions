...
import { mockInventory, mockDispensing, mockSuppliers, mockPurchaseOrders, mockCategories, mockSalesData } from './mockData';
...
import { ReturnAdjustmentManager } from './components/ReturnAdjustmentManager';
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Inventory, dispensing, suppliers, and analytics</p>
        </div>
