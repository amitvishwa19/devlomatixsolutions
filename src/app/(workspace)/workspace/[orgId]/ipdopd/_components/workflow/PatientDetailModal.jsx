...
import {
    User, Phone, Calendar, Stethoscope, MapPin, ArrowRight,
    Clock, FileText, Activity, CheckCircle2
} from 'lucide-react';
...
export function PatientDetailModal({ patient, open, onClose, onAdvanceStage }) {
    ...
    return (
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-3xl max-h-[90vh] p-0 overflow-hidden">
                <DialogHeader className="p-6 pb-4 gradient-hero text-primary-foreground">
