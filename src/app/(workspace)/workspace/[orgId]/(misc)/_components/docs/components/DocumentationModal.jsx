...
import { VideoTutorial, InteractiveWalkthrough } from '.';
import { DOCUMENTATION_SECTIONS } from "../utils/documentationData";
...
export default function DocumentationModal({ isOpen, onClose }) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            ...
            <DialogContent className='min-w-[90%] max-w-[90%] min-h-[90%] max-h-[90%] print:block overflow-hidden p-0'>
                <DialogHeader className={'hidden'}>
                    <DialogTitle className='text-sm'>Documentation</DialogTitle>
                    <DialogDescription className='text-xs'>
                        Carewell User Guide • Use ↑↓ to navigate
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="flex flex-row ">
                    ...
                    <div className="w-72 border-r border-border bg-card shrink-0 sticky top-0 h-screen print:hidden">
                        <div className="p-4 border-b border-border">
                            <h2 className="font-bold text-foreground">Documentation</h2>
                            <p className="text-xs text-muted-foreground">{process.env.NEXT_PUBLIC_APP_NAME} User Guide • Use ↑↓ to navigate</p>
                        </div>
                        <div className="p-3">
                    ...
                    <ScrollArea className="h-[90vh] p-4">
                        <div ref={mainContentRef} className="flex-1 p-2 overflow-auto print:p-0 print:overflow-visible">
                            {renderContent()}
                        </div>
                    </ScrollArea>
