                    ...
                    <HoverCard>
                        <HoverCardTrigger asChild>
                            <Button variant="ghost" size="sm" className="h-7 px-2 gap-1.5">
                                ...
                                <span className="text-sm font-medium">{moduleUsers.length}</span>
                            </Button>
                        </HoverCardTrigger>
                            ...
                            <div className="space-y-3">
                                ...
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className="text-sm font-semibold">Roles ({moduleRoles.length})</span>
                                    </div>
                                ...
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className="text-sm font-semibold">Users ({moduleUsers.length})</span>
                                    </div>
