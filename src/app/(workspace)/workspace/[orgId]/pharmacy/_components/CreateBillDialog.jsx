...
import { mockMedicines } from '../_data/mockData';
    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="min-w-[620px] bg-transparent border-0 p-2">
                <div className='bg-card rounded-md border h-full overflow-hidden'>
                    <SheetHeader>
                    ...
                    <ScrollArea className="space-y-6 p-4 h-[90vh]">
                        <div className='space-y-4'>
                            {/* Bill Header */}
                            <div className="bg-secondary/30 rounded-lg p-4 space-y-2 border">
