    ...
    <div className="relative w-full h-screen bg-gradient-dark overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-8">
        ...
        <motion.h2
          ...
          className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground text-center mb-16"
        >
          Trusted by
          <span className="block text-gradient-light">Healthcare Leaders</span>
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="glass-dark rounded-2xl p-8 flex flex-col"
            >
              <Quote className="h-10 w-10 text-primary/30 mb-4" />
              <p className="text-primary-foreground/90 mb-6 italic flex-1">
                "{testimonial.quote}"
              </p>
              <div>
