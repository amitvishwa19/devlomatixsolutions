    ...
    <div className="relative w-full h-screen bg-gradient-dark overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-8 text-center">
        ...
        <motion.h2
          ...
          className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-primary-foreground mb-6"
        >
          Complete Hospital
          <span className="block text-gradient-light">Management System</span>
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-xl md:text-2xl text-primary-foreground/80 max-w-3xl leading-relaxed"
        >
        ...
        >
          {["16+ Modules", "Real-time Dashboards", "HIPAA Compliant", "Cloud-Based"].map((feature, index) => (
            <motion.div
              ...
              className="flex items-center gap-2 glass-dark px-5 py-2.5 rounded-full"
            >
