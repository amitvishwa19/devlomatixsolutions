...
const Benefits = () => {
  return (
    <section id="benefits" className="py-28 relative overflow-hidden">
      ...
      <div className="absolute -bottom-40 -left-40 w-[400px] h-[400px] rounded-full bg-primary/3 blur-[150px]" />
            ...
            >
              <div className="relative">
                ...
                <div className="mb-4">
                  ...
                  <span className="text-xs text-muted-foreground ml-2 uppercase tracking-wider">{b.metricLabel}</span>
                </div>
