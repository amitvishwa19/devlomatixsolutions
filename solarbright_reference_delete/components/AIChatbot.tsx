  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-[360px] max-h-[500px] bg-card border border-border rounded-2xl shadow-2xl flex flex-col overflow-hidden"
          >
            {/* Header */}
            <div className="bg-primary text-primary-foreground px-4 py-3 flex items-center gap-2">
              <Bot className="w-5 h-5" />
              <div>
                <p className="font-heading font-bold text-sm">SolarShine AI</p>
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-3 min-h-[280px] max-h-[340px]">
              {messages.length === 0 && (
                <div className="text-center text-muted-foreground text-sm py-8">
                  ...
                  <p className="text-xs mt-1">Ask about our cleaning services, pricing, or plans.</p>
                </div>
              )}
              {messages.map((msg, i) => (
