...
import { Shield, AlertTriangle, CheckCircle2, Users, TrendingUp, FileText } from "lucide-react";
                  ...
                  {ethnicityData.map((item, i) => (
                    <div key={item.name} className="space-y-1">
                      ...
                      <div className="h-2 rounded-full bg-muted overflow-hidden">
                        <div className="h-full rounded-full transition-all" style={{ width: `${item.value}%`, backgroundColor: COLORS[i] }} />
                      </div>
                    </div>
                  ))}
                </div>
