...
import { Eye, Palette, Type, Image, Layout, Globe, MapPin, Briefcase, Clock, ExternalLink, Code } from "lucide-react";
        ...
        <Tabs defaultValue="content" className="space-y-6">
          ...
          <TabsContent value="settings">
            <Card>
              ...
              <CardContent className="space-y-4">
                {[
                  { label: "Show Salary Range", desc: "Display compensation on job listings", key: "showSalary" as const },
                  { label: "Show Location", desc: "Display job location", key: "showLocation" as const },
                  { label: "Department Filter", desc: "Allow filtering jobs by department", key: "showDepartmentFilter" as const },
                ].map((item) => (
