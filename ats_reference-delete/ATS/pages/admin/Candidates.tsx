...
import { stages, sources } from "@/ATS/data/mockData";
import StageBadge from "@/ATS/components/StageBadge";
import StarRating from "@/ATS/components/StarRating";
import AddCandidateDialog from "@/ATS/components/AddCandidateDialog";
import BulkActions from "@/ATS/components/BulkActions";
import AdvancedFilters, { FilterState, defaultFilters } from "@/ATS/components/AdvancedFilters";
              ...
              <TableBody>
                {filtered.map((c) => (
                  <TableRow key={c.id} className="group">
                    ...
                    <TableCell>
                      <Link to={`/admin/candidates/${c.id}`} className="flex items-center gap-3 hover:underline">
