...
import { Users, Clock, Target, TrendingUp, Star, Calendar, CheckCircle2 } from "lucide-react";
          ...
          <Card key={member.id}>
            <CardContent className="p-4">
              ...
              <div className="space-y-2 mb-3">
                ...
                <Progress value={member.capacity} className={`h-2 [&>div]:${getCapacityBg(member.capacity)}`} />
              </div>
