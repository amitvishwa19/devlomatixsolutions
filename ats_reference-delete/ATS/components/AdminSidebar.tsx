...
import { LayoutDashboard, Briefcase, Users, Kanban, Calendar, BarChart3, Settings, Menu, X, Briefcase as Logo, ChevronLeft, UserSearch, FileText, FileCheck, GitCompare, PieChart, Zap, Shield, Globe, UsersRound, UserPlus, ScrollText, HelpCircle, MoreVertical } from "lucide-react";
...
import NotificationCenter from "@/ATS/components/NotificationCenter";
...
const navItems = [
  ...
  { to: "/admin/talent-pool", icon: UserSearch, label: "Talent Pool" },
  { to: "/admin/resumes", icon: FileText, label: "Resumes" },
  { to: "/admin/offers", icon: FileCheck, label: "Offers" },
  { to: "/admin/compare", icon: GitCompare, label: "Compare" },
  ...
  { to: "/admin/career-page", icon: Globe, label: "Career Page" },
  { to: "/admin/team-workload", icon: UsersRound, label: "Team" },
    ...
    <aside className={cn(
      ...
      <div className="flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          {!collapsed && <span className="text-lg font-bold text-sidebar-primary-foreground">HireFlow</span>}
        </div>
        <button
      ...
      <div className="border-t border-sidebar-border p-2 space-y-1">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent side="right" align="end" className="w-56 ml-2 mb-2">
            ...
            <DropdownMenuItem asChild>
              <Link to="/admin/help" className="flex items-center gap-2 cursor-pointer">
