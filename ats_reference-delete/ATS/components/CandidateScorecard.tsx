...
const ScoreInput = ({ value, onChange, max = 5 }: { value: number; onChange: (v: number) => void; max?: number }) => (
...
const CandidateScorecard = ({ candidateId, jobId }: { candidateId: string; jobId: string }) => {
